import{$ as f,$c as rt,Ac as X,C as y,Ca as t,D as M,Da as c,Ea as h,F as E,Fa as b,Fc as Y,G as w,Ge as Ct,Gf as Et,H as R,Hc as Z,He as ft,Ic as tt,Ie as xt,Jc as et,Jf as wt,K as k,Kc as it,Ke as ht,L as $,Le as bt,Na as T,Ne as vt,Ob as B,Oe as gt,Pc as at,Qa as m,Qe as _t,Ra as p,Rb as V,Re as St,Sb as F,Sc as nt,Te as It,Ub as A,Vc as lt,Yc as ot,Zb as O,Zd as j,_ as o,ae as N,bb as Q,bg as Rt,cd as mt,ce as ut,dd as pt,ea as d,ga as C,hd as st,jd as ct,ka as i,la as a,lc as W,ma as u,na as S,nb as z,oa as I,pd as dt,qa as U,ra as P,rb as J,sa as G,tb as K,tf as Dt,uc as L,wf as yt,zf as Mt}from"./chunk-USZS4HIY.js";import"./chunk-O7S4L63H.js";var g=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let _=new J().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(_=_.set("officeId",v)),this.http.get("/clients",{params:_})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(E(K))}}static{this.\u0275prov=y({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var jt=()=>["edit"];function Nt(e,s){e&1&&(i(0,"button",16),t(1,`

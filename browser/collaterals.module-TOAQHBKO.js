import{$c as pt,$e as Mt,Bb as Y,Bd as ft,Cc as tt,Dd as xt,E,F as y,Fa as t,Ga as c,Gc as et,Gd as ht,H as w,Ha as h,Hc as it,Ia as b,Ic as at,Jc as nt,K as Q,Kd as bt,Kf as Rt,L as z,Nf as Pt,Oc as lt,Pa as B,Rc as ot,Sa as m,Ta as p,Tb as F,Te as vt,Uc as rt,Ue as gt,Ve as _t,Wb as O,Wf as Tt,Xb as V,Xc as mt,Xe as St,Ye as Dt,Zb as U,_ as o,_e as It,ac as L,bd as A,bf as Et,ca as f,cb as W,cd as j,cf as yt,da as R,ea as P,ef as wt,fd as H,ha as d,hd as st,ja as C,ld as ct,md as dt,na as i,nc as Z,oa as a,pa as u,pg as Bt,qa as D,qb as g,qd as ut,ra as I,sd as Ct,ta as J,ua as T,va as K,wc as N,yb as X}from"./chunk-AMB5AC4Y.js";import"./chunk-O7S4L63H.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`

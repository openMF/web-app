import{$b as L,Ab as Y,Ad as ft,Bc as tt,Cd as xt,D as E,E as y,Ea as t,Fa as c,Fc as et,Fd as ht,G as w,Ga as h,Gc as it,Ha as b,Hc as at,Ic as nt,J as Q,Jd as bt,Jf as Rt,K as z,Mf as Pt,Nc as lt,Oa as B,Qc as ot,Ra as m,Sa as p,Sb as F,Se as vt,Tc as rt,Te as gt,Ue as _t,Vb as O,Vf as Tt,Wb as V,Wc as mt,We as St,Xe as Dt,Yb as U,Z as o,Ze as It,_c as pt,_e as Mt,ad as A,af as Et,ba as f,bb as W,bd as j,bf as yt,ca as R,da as P,df as wt,ed as H,ga as d,gd as st,ia as C,kd as ct,ld as dt,ma as i,mc as Z,na as a,oa as u,og as Bt,pa as D,pb as g,pd as ut,qa as I,rd as Ct,sa as J,ta as T,ua as K,vc as N,xb as X}from"./chunk-IQC626QT.js";import"./chunk-O7S4L63H.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`

...
`),a(),t(21,`
`)),s&2&&(o(),u(m(2,5,"labels.heading.Calculate Interest")),o(6),v("",m(8,7,"labels.text.Are you sure you want to calculate interest")," ?"),o(7),u(m(15,9,"labels.buttons.Cancel")),o(3),l("mat-dialog-close",B(13,Qi)),o(),v(`
    `,m(19,11,"labels.buttons.Confirm"),`
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var Ki=()=>({confirm:!0}),vn=(()=>{class e{constructor(n){this.dialogRef=n}static{this.\u0275fac=function(s){return new(s||e)(x(te))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-post-interest-dialog"]],decls:22,vars:14,consts:[["mat-dialog-title",""],["mat-dialog-content",""],["align","end"],["mat-raised-button","","mat-dialog-close",""],["mat-raised-button","","color","primary",3,"mat-dialog-close"]],template:function(s,r){s&1&&(i(0,"h1",0),t(1),c(2,"translate"),a(),t(3,`
`),i(4,"div",1),t(5,`
  `),i(6,"p"),t(7),c(8,"translate"),a(),t(9,`
`),a(),t(10,`
`),i(11,"mat-dialog-actions",2),t(12,`
  ...
  `),i(17,"button",4),t(18),c(19,"translate"),a(),t(20,`
`),a(),t(21,`
`)),s&2&&(o(),u(m(2,5,"labels.heading.Post Interest")),o(6),v("",m(8,7,"labels.text.Are you sure you want to post interest")," ?"),o(7),u(m(15,9,"labels.buttons.Cancel")),o(3),l("mat-dialog-close",B(13,Ki)),o(),v(`
    `,m(19,11,"labels.buttons.Confirm"),`
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var Yi=()=>({confirm:!0}),ze=(()=>{class e{constructor(n,s){this.dialogRef=n,this.data=s}static{this.\u0275fac=function(s){return new(s||e)(x(te),x(Ee))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-toggle-withhold-tax-dialog"]],decls:25,vars:24,consts:[["mat-dialog-title",""],["mat-dialog-content",""],["align","end"],["mat-raised-button","","mat-dialog-close",""],["mat-raised-button","",3,"color","mat-dialog-close"]],template:function(s,r){s&1&&(i(0,"h1",0),t(1),c(2,"translate"),c(3,"translate"),a(),t(4,`
`),i(5,"div",1),t(6,`
...
`),o(7),De(`
  ...
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var xn=class{constructor(p,n){this.setOptions(p),this.setButtons(p,n)}get singleButtons(){return this.buttonsArray}get options(){return this.optionArray}setButtons(p,n){switch(p){case"Active":this.buttonsArray=[],n.block?this.buttonsArray=[{name:"Unblock Account",icon:"lock-open",taskPermissionName:"UNBLOCK_SAVINGSACCOUNT"}]:(n.blockCredit?this.buttonsArray.push({name:"Unblock Deposit",icon:"lock-open",taskPermissionName:"UNBLOCKDEPOSIT_SAVINGSACCOUNT"}):this.buttonsArray.push({name:"Deposit",icon:"arrow-up",taskPermissionName:"DEPOSIT_SAVINGSACCOUNT"},{name:"Block Deposit",icon:"lock",taskPermissionName:"BLOCKDEPOSIT_SAVINGSACCOUNT"}),n.blockDebit?this.buttonsArray.push({name:"Unblock Withdrawal",icon:"lock-open",taskPermissionName:"UNBLOCKWITHDRAWAL_SAVINGSACCOUNT"}):this.buttonsArray.push({name:"Withdrawal",icon:"arrow-down",taskPermissionName:"WITHDRAWAL_SAVINGSACCOUNT"},{name:"Block Withdrawal",icon:"lock",taskPermissionName:"BLOCKWITHDRAWAL_SAVINGSACCOUNT"}),this.buttonsArray=this.buttonsArray.concat([{name:"Block Account",icon:"lock",taskPermissionName:"BLOCK_SAVINGSACCOUNT"},{name:"Hold Amount",icon:"lock",taskPermissionName:"HOLDAMOUNT_SAVINGSACCOUNT"},{name:"Calculate Interest",icon:"table",taskPermissionName:"CALCULATEINTEREST_SAVINGSACCOUNT"},{name:"Post Interest As On",icon:"arrow-right",taskPermissionName:"POSTINTEREST_SAVINGSACCOUNT"}]));break;case"Submitted and pending approval":this.buttonsArray=[{name:"Modify Application",icon:"pen",taskPermissionName:"UPDATE_SAVINGSACCOUNT"},{name:"Approve",icon:"check",taskPermissionName:"APPROVE_SAVINGSACCOUNT"}];break;case"Approved":this.buttonsArray=[{name:"Undo Approval",icon:"undo",taskPermissionName:"APPROVALUNDO_SAVINGSACCOUNT"},{name:"Activate",icon:"check",taskPermissionName:"ACTIVATE_SAVINGSACCOUNT"},{name:"Add Charge",icon:"plus",taskPermissionName:"CREATE_SAVINGSACCOUNTCHARGE"}];break;default:this.buttonsArray=[]}}setOptions(p){switch(p){case"Active":this.optionArray=[{name:"Post Interest",taskPermissionName:"POSTINTEREST_SAVINGSACCOUNT"},{name:"Add Charge",taskPermissionName:"CREATE_SAVINGSACCOUNTCHARGE"},{name:"Close",taskPermissionName:"CLOSE_SAVINGSACCOUNT"}];break;case"Submitted and pending approval":this.optionArray=[{name:"Reject",taskPermissionName:"REJECT_SAVINGSACCOUNT"},{name:"Withdrawn by Client",taskPermissionName:"WITHDRAW_SAVINGSACCOUNT"},{name:"Add Charge",taskPermissionName:"CREATE_SAVINGSACCOUNTCHARGE"},{name:"Delete",taskPermissionName:"DELETE_SAVINGSACCOUNT"}];break;case"Approved":default:this.optionArray=[]}}addOption(p){this.optionArray.push(p)}};var Ji=()=>["./general"],Xi=()=>["./transactions"],Zi=()=>["./charges"],ta=()=>["./documents"],ea=()=>["./notes"],na=()=>["./standing-instructions"],ia=e=>["./datatables",e];function aa(e,p){if(e&1&&(f(0,"i",33),c(1,"statusLookup")),e&2){let n=C();l("ngClass",m(1,2,n.savingsAccountData.status.code))("matTooltip",n.savingsAccountData.status.value)}}function oa(e,p){if(e&1&&(f(0,"i",33),c(1,"statusLookup")),e&2){let n=C();l("ngClass",m(1,2,n.savingsAccountData.subStatus.value))("matTooltip",n.savingsAccountData.subStatus.value)}}function ra(e,p){if(e&1&&(i(0,"span",34),t(1,`
          ...
          `),a()),e&2){let n=C();o(3),u(m(4,5,"labels.heading.Account Overview")),o(10),u(m(14,7,"labels.inputs.Current Balance")),o(4),v(`
                  ...
                  `)}}function ca(e,p){if(e&1){let n=P();i(0,"button",39),h("click",function(){b(n);let r=C().$implicit,g=C();return M(g.doAction(r.name))}),t(1,`
            `),i(2,"mat-icon",40),t(3,`
              `),f(4,"fa-icon",41),t(5,`
            `),a(),t(6,`
            `),i(7,"span"),t(8),c(9,"translate"),a(),t(10,`
          `),a()}if(e&2){let n=C().$implicit;o(4),gt("icon",n.icon),o(4),v(" ",m(9,2,"labels.menus."+n.name)," ")}}function ma(e,p){if(e&1&&(E(0),t(1,`
          `),d(2,ca,11,4,"button",38),t(3,`
        `),w()),e&2){let n=p.$implicit;o(2),l("mifosxHasPermission",n.taskPermissionName)}}function la(e,p){if(e&1){let n=P();i(0,"button",39),h("click",function(){b(n);let r=C().$implicit,g=C(2);return M(g.doAction(r.name))}),t(1),c(2,"translate"),a()}if(e&2){let n=C().$implicit;o(),v(`
                `,m(2,1,"labels.menus."+n.name),`
              `)}}function pa(e,p){if(e&1&&(i(0,"span"),t(1,`
              `),d(2,la,3,3,"button",38),t(3,`
            `),a()),e&2){let n=p.$implicit;o(2),l("mifosxHasPermission",n.taskPermissionName)}}function da(e,p){if(e&1&&(E(0),t(1,`
          `),i(2,"button",42),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"mat-menu",null,2),t(8,`
            `),d(9,pa,4,1,"span",29),t(10,`
          `),a(),t(11,`
        `),w()),e&2){let n=O(7),s=C();o(2),l("matMenuTriggerFor",n),o(),u(m(4,3,"labels.menus.More")),o(6),l("ngForOf",s.buttonConfig.options)}}function ua(e,p){if(e&1&&(i(0,"a",44,7),t(2),c(3,"translate"),a()),e&2){let n=O(1);l("routerLink",B(5,ea))("active",n.isActive),o(2),v(`
        `,m(3,3,"labels.inputs.Notes"),`
      `)}}function ga(e,p){if(e&1&&(i(0,"a",44,8),t(2),c(3,"translate"),a()),e&2){let n=O(1);l("routerLink",B(5,na))("active",n.isActive),o(2),v(`
          `,m(3,3,"labels.inputs.Standing Instructions"),`
        `)}}function fa(e,p){if(e&1&&(E(0),t(1,`
        `),d(2,ga,4,6,"a",47),t(3,`
      `),w()),e&2){let n=C(2);o(2),l("ngIf",n.savingsAccountData.clientId)}}function va(e,p){if(e&1&&(i(0,"a",44,9),t(2),a()),e&2){let n=O(1),s=C().$implicit;l("routerLink",Nt(3,ia,s.registeredTableName))("active",n.isActive),o(2),v(`
          `,s.registeredTableName,`
        `)}}function xa(e,p){if(e&1&&(E(0),t(1,`
        `),d(2,va,3,5,"a",45),t(3,`
      `),w()),e&2){let n=p.$implicit;o(2),l("mifosxHasPermission","READ_"+n.registeredTableName)}}function _a(e,p){if(e&1&&(i(0,"nav",43),t(1,`
      ...
      `),d(22,ua,4,6,"a",45),t(23,`
      `),d(24,fa,4,1,"ng-container",46),t(25,`
      `),d(26,xa,4,1,"ng-container",29),t(27,`
    `),a()),e&2){let n=O(3),s=O(8),r=O(13),g=O(18),_=C(),S=O(75);l("tabPanel",S),o(2),l("routerLink",B(24,Ji))("active",n.isActive),o(2),v(`
        `,m(5,16,"labels.inputs.General"),`
      `),o(3),l("routerLink",B(25,Xi))("active",s.isActive),o(2),v(`
        `,m(10,18,"labels.inputs.Transactions"),`
      `),o(3),l("routerLink",B(26,Zi))("active",r.isActive),o(2),v(`
        `,m(15,20,"labels.inputs.Charges"),`
      `),o(3),l("routerLink",B(27,ta))("active",g.isActive),o(2),v(`
    ...
    `),i(4,"mat-card-title-group",12),t(5,`
      ...
      `),i(15,"div",15),t(16,`
        `),i(17,"mat-card-title",16),t(18,`
          `),i(19,"div",17),t(20,`
            `),i(21,"h3"),t(22,`
              `),d(23,aa,2,4,"i",18),t(24,`
              `),d(25,oa,2,4,"i",18),t(26,`
              `),i(27,"span",19),t(28),c(29,"translate"),a(),t(30,`
              `),i(31,"span",19),f(32,"mifosx-long-text",20),a(),t(33,`
              `),f(34,"mifosx-account-number",21),t(35,`
            `),a(),t(36,`
            `),i(37,"span",22),t(38),c(39,"translate"),c(40,"translate"),d(41,ra,4,1,"span",23),t(42,`
            `),a(),t(43,`
          `),a(),t(44,`

          `),d(45,sa,34,21,"div",24),t(46,`
      ...
      `),i(60,"mat-menu",null,0),t(62,`
        `),d(63,ma,4,1,"ng-container",29),t(64,`

        `),d(65,da,12,5,"ng-container",30),t(66,`
      `),a(),t(67,`
    `),a(),t(68,`
  `),a(),t(69,`
  ...
  `),a(),t(80,`
`),a(),t(81,`
`)),s&2){let g=O(61);o(10),gt("matTooltip",m(11,16,"tooltips.Savings Account")),l("src","assets/images/savings_account_placeholder.png",_i),o(13),l("ngIf",!r.savingsAccountData.subStatus.block),o(2),l("ngIf",r.savingsAccountData.subStatus.block),o(3),v("",m(29,18,"labels.inputs.Savings Product")," :"),o(4),gt("textValue",r.savingsAccountData.savingsProductName),o(2),gt("accountNo",r.savingsAccountData.accountNo),o(4),De(`
      ...
      `),a()}if(e&2){let n=C();o(2),l("formControl",n.hideReversedParam),o(),v(`
          ...
          `,m(8,8,"labels.inputs.Hide Accruals"),""),o(3),l("routerLink",B(12,ha)),o(),v(`
          `,m(12,10,"labels.buttons.Export"),`
        `)}}function Aa(e,p){e&1&&(i(0,"th",34),t(1,"#"),a())}function Ta(e,p){if(e&1){let n=P();i(0,"td",35),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),a()}if(e&2){let n=p.index;o(),v(`
          `,n+1,`
        `)}}function ya(e,p){e&1&&(i(0,"th",34),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Id")))}function Pa(e,p){if(e&1){let n=P();i(0,"td",36),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,n.id,`
        `)}}function Ia(e,p){e&1&&(i(0,"th",37),t(1),c(2,"translate"),a()),e&2&&(o(),v(`
          `,m(2,1,"labels.inputs.Transaction Date"),`
        `))}function Da(e,p){if(e&1){let n=P();i(0,"td",38),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),c(2,"dateFormat"),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,m(2,2,n.date),`
        `)}}function Oa(e,p){e&1&&(i(0,"th",34),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.External Id")))}function Ea(e,p){if(e&1&&(i(0,"td",39),t(1,`
          `),f(2,"mifosx-external-identifier",40),t(3,`
        `),a()),e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(2),gt("externalId",n.externalId)}}function wa(e,p){e&1&&(i(0,"th",41),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Transaction Type")))}function Fa(e,p){if(e&1){let n=P();i(0,"td",38),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),c(2,"translateKey"),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,bt(2,2,n.transactionType.value,"catalogs"),`
        `)}}function ka(e,p){e&1&&(i(0,"th",42),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Debit")))}function Ba(e,p){if(e&1){let n=P();i(0,"td",43),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),c(2,"formatNumber"),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,s.isDebit(n.transactionType)?m(2,2,n.amount):"N/A",`
        `)}}function Na(e,p){e&1&&(i(0,"th",42),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Credit")))}function Ra(e,p){if(e&1){let n=P();i(0,"td",43),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),c(2,"formatNumber"),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,s.isDebit(n.transactionType)?"N/A":m(2,2,n.amount),`
        `)}}function Va(e,p){e&1&&(i(0,"th",42),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Balance")))}function La(e,p){if(e&1){let n=P();i(0,"td",43),h("click",function(){let r=b(n).$implicit,g=C();return M(g.showTransactions(r))}),t(1),c(2,"formatNumber"),a()}if(e&2){let n=p.$implicit,s=C();l("ngClass",s.savingsTransactionColor(n)),o(),v(`
          `,m(2,2,n.runningBalance),`
        `)}}function ja(e,p){e&1&&(i(0,"th",41),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Actions")))}function Ga(e,p){if(e&1){let n=P();i(0,"button",46),h("click",function(r){b(n);let g=C(2).$implicit,_=C();return M(_.undoTransaction(g,r))}),t(1,`
                `),i(2,"mat-icon"),f(3,"fa-icon",54),a(),t(4,`
                `),i(5,"span"),t(6),c(7,"translate"),a(),t(8,`
              `),a()}e&2&&(o(6),u(m(7,1,"tooltips.Undo Transaction")))}function Ua(e,p){e&1&&(i(0,"span"),t(1,`
              `),d(2,Ga,9,3,"button",53),t(3,`
            `),a()),e&2&&(o(2),l("mifosxHasPermission","ADJUSTTRANSACTION_SAVINGSACCOUNT"))}function qa(e,p){if(e&1){let n=P();i(0,"td",44),t(1,`
          `),i(2,"button",45),t(3,`
  ...
  `),i(2,"div",2),t(3,`
    `),i(4,"div",3),t(5,`
      `),d(6,Ma,14,13,"div",4),t(7,`
    `),a(),t(8,`

    `),i(9,"table",5),t(10,`
      `),E(11,6),t(12,`
        `),d(13,Aa,2,0,"th",7),t(14,`
        `),d(15,Ta,2,1,"td",8),t(16,`
      `),w(),t(17,`

      `),E(18,9),t(19,`
        `),d(20,ya,3,3,"th",7),t(21,`
        `),d(22,Pa,2,2,"td",10),t(23,`
      `),w(),t(24,`
      ...
      `),E(32,14),t(33,`
        `),d(34,Oa,3,3,"th",7),t(35,`
        `),d(36,Ea,4,2,"td",15),t(37,`
      `),w(),t(38,`

      `),E(39,16),t(40,`
        `),d(41,wa,3,3,"th",17),t(42,`
        `),d(43,Fa,3,5,"td",13),t(44,`
      `),w(),t(45,`

      `),E(46,18),t(47,`
        `),d(48,ka,3,3,"th",19),t(49,`
        `),d(50,Ba,3,4,"td",20),t(51,`
      `),w(),t(52,`

      `),E(53,21),t(54,`
        `),d(55,Na,3,3,"th",19),t(56,`
        `),d(57,Ra,3,4,"td",20),t(58,`
      `),w(),t(59,`

      `),E(60,22),t(61,`
        `),d(62,Va,3,3,"th",19),t(63,`
        `),d(64,La,3,4,"td",20),t(65,`
      `),w(),t(66,`

      `),E(67,23),t(68,`
        `),d(69,ja,3,3,"th",17),t(70,`
        `),d(71,qa,45,20,"td",24),t(72,`
      `),w(),t(73,`

      `),d(74,Ha,1,0,"tr",25),t(75,`
      `),d(76,za,1,0,"tr",26),t(77,`
    `),a(),t(78,`
...
`)),s&2&&(o(2),l("entityId",r.entityId)("multiRowDatatableFlag",r.multiRowDatatableFlag)("entityDatatable",r.entityDatatable))},dependencies:[T,y,un],encapsulation:2})}}return e})();var $a=()=>["../../"];function Wa(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
  ...
  `),a(),t(49,`
`),a(),t(50,`
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.approveSavingsAccountForm),o(9),u(m(14,12,"labels.inputs.Approved On Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.approveSavingsAccountForm.controls.approvedOnDate.hasError("required")),o(6),u(m(30,14,"labels.inputs.Note")),o(10),l("routerLink",B(20,$a)),o(),v(`
          `,m(41,16,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.approveSavingsAccountForm.valid),o(),v(`
          `,m(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I,re],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Qa=()=>["../../"];function Ka(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
  ...
  `),a(),t(49,`
`),a(),t(50,`
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.rejectSavingsAccountForm),o(9),u(m(14,12,"labels.inputs.Rejected On Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.rejectSavingsAccountForm.controls.rejectedOnDate.hasError("required")),o(6),u(m(30,14,"labels.inputs.Note")),o(10),l("routerLink",B(20,Qa)),o(),v(`
          `,m(41,16,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.rejectSavingsAccountForm.valid),o(),v(`
          `,m(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I,re],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Ya=()=>["../../transactions"];function Ja(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
  ...
  `),a(),t(40,`
`),a(),t(41,`
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.activateSavingsAccountForm),o(9),u(m(14,11,"labels.inputs.Activated On Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.activateSavingsAccountForm.controls.activatedOnDate.hasError("required")),o(7),l("routerLink",B(17,Ya)),o(),v(`
  ...
  `),a(),t(30,`
`),a(),t(31,`
`)),s&2&&(o(4),l("formGroup",r.undoApprovalSavingsAccountForm),o(7),u(m(12,6,"labels.inputs.Note")),o(9),l("routerLink",B(12,Xa)),o(),v(`
          `,m(22,8,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.undoApprovalSavingsAccountForm.valid),o(),v(`
          `,m(26,10,"labels.buttons.Confirm"),`
        `))},dependencies:[T,y,at,nt,K,it,ot,rt,G,J,ct,ht,Z,X,mt,k,I,re],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Za=()=>["../../"];function to(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
          `),a()),e&2&&(o(),R(`
  ...
  `),a(),t(37,`
`),a(),t(38,`
`)}if(s&2){let g=O(19);o(4),l("formGroup",r.postInterestSavingsAccountForm),o(7),u(m(12,11,"labels.inputs.Transaction Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.postInterestSavingsAccountForm.controls.transactionDate.hasError("required")),o(6),l("routerLink",B(17,Za)),o(),v(`
          `,m(29,13,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.postInterestSavingsAccountForm.valid),o(),v(`
          `,m(33,15,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var eo=()=>["../../"];function no(e,p){if(e&1&&(i(0,"mat-option",14),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                `,n.displayName,`
              `)}}function io(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
...
`)}if(s&2){let g=O(33);o(4),l("formGroup",r.savingsAssignStaffForm),o(9),u(m(14,13,"labels.inputs.To Savings Officer")),o(5),l("ngForOf",r.fieldOfficerData),o(7),u(m(26,15,"labels.inputs.Assignment Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.savingsAssignStaffForm.controls.assignmentDate.hasError("required")),o(7),l("routerLink",B(21,eo)),o(),v(`
  ...
  `),a(),t(37,`
`),a(),t(38,`
`)}if(s&2){let g=O(19);o(4),l("formGroup",r.savingsUnassignStaffForm),o(7),u(m(12,11,"labels.inputs.Unassignment Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.savingsUnassignStaffForm.controls.unassignedDate.hasError("required")),o(6),l("routerLink",B(17,ao)),o(),v(`
          `,m(29,13,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.savingsUnassignStaffForm.valid),o(),v(`
          `,m(33,15,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var ro=()=>["../../"];function so(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
  ...
  `),a(),t(49,`
`),a(),t(50,`
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.withdrawSavingsAccountForm),o(9),u(m(14,12,"labels.inputs.Withdrawn On Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.withdrawSavingsAccountForm.controls.withdrawnOnDate.hasError("required")),o(6),u(m(30,14,"labels.inputs.Note")),o(10),l("routerLink",B(20,ro)),o(),v(`
          `,m(41,16,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.withdrawSavingsAccountForm.valid),o(),v(`
          `,m(45,18,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I,re],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var co=()=>["../../transactions"];function mo(e,p){if(e&1&&(i(0,"mat-option",12),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                `,n.name+" ("+n.currency.name+")",`
              `)}}function lo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
              `,m(2,3,"labels.inputs.Charge")," ",m(3,5,"labels.commons.is"),`
              `),o(4),u(m(6,7,"labels.commons.required")))}function po(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
              `),a()),e&2&&(o(),R(`
                `,m(2,3,"labels.inputs.Amount")," ",m(3,5,"labels.commons.is"),`
                `),o(4),u(m(6,7,"labels.commons.required")))}function uo(e,p){if(e&1&&(i(0,"mat-option",12),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                  `,n.value,`
                `)}}function go(e,p){if(e&1&&(i(0,"mat-option",12),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                  `,n.value,`
                `)}}function fo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
              `),a()),e&2&&(o(),R(`
                `,m(2,3,"labels.inputs.Due for collection on")," ",m(3,5,"labels.commons.is"),`
                `),o(4),u(m(6,7,"labels.commons.required")))}function vo(e,p){if(e&1){let n=P();i(0,"mat-form-field",17),h("click",function(){b(n);let r=O(11);return M(r.open())}),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",18),t(7,`
              `),f(8,"mat-datepicker-toggle",19),t(9,`
              `),f(10,"mat-datepicker",null,0),t(12,`
              `),d(13,fo,8,9,"mat-error",7),t(14,`
            `),a()}if(e&2){let n=O(11),s=C(2);o(3),u(m(4,6,"labels.inputs.Due for collection on")),o(3),l("min",s.minDate)("max",s.maxDate)("matDatepicker",n),o(2),l("for",n),o(5),l("ngIf",s.savingsChargeForm.controls.dueDate.hasError("required"))}}function xo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
              `),a()),e&2&&(o(),R(`
                ...
                `),o(4),u(m(6,7,"labels.commons.required")))}function _o(e,p){if(e&1){let n=P();i(0,"mat-form-field",17),h("click",function(){b(n);let r=O(11);return M(r.open())}),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",20),t(7,`
              `),f(8,"mat-datepicker-toggle",19),t(9,`
              `),f(10,"mat-datepicker",null,1),t(12,`
              `),d(13,xo,8,9,"mat-error",7),t(14,`
            `),a()}if(e&2){let n=O(11),s=C(2);o(3),u(m(4,6,"labels.inputs.Due On")),o(3),l("min",s.minDate)("max",s.maxDate)("matDatepicker",n),o(2),l("for",n),o(5),l("ngIf",s.savingsChargeForm.controls.feeOnMonthDay.hasError("required"))}}function Co(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",21),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Repeats Every")))}function ho(e,p){if(e&1&&(i(0,"div",4),t(1,`
            `),i(2,"mat-form-field"),t(3,`
              `),i(4,"mat-label"),t(5),c(6,"translate"),a(),t(7,`
              `),f(8,"input",13),t(9,`
              `),d(10,po,8,9,"mat-error",7),t(11,`
            `),a(),t(12,`

            `),i(13,"mat-form-field"),t(14,`
              `),i(15,"mat-label"),t(16),c(17,"translate"),a(),t(18,`
              `),i(19,"mat-select",14),t(20,`
                `),d(21,uo,2,2,"mat-option",6),t(22,`
              `),a(),t(23,`
            `),a(),t(24,`
            ...
            `),i(25,"mat-form-field"),t(26,`
              ...
              `),i(31,"mat-select",15),t(32,`
                `),d(33,go,2,2,"mat-option",6),t(34,`
              `),a(),t(35,`
            `),a(),t(36,`

            `),d(37,vo,15,8,"mat-form-field",16),t(38,`

            `),d(39,_o,15,8,"mat-form-field",16),t(40,`

            `),d(41,Co,8,3,"mat-form-field",7),t(42,`
      ...
      `),i(6,"mat-card-content"),t(7,`
        `),i(8,"div",4),t(9,`
          `),i(10,"mat-form-field"),t(11,`
            `),i(12,"mat-label"),t(13),c(14,"translate"),a(),t(15,`
            `),i(16,"mat-select",5),t(17,`
              `),d(18,mo,2,2,"mat-option",6),t(19,`
            `),a(),t(20,`
            `),d(21,lo,8,9,"mat-error",7),t(22,`
          `),a(),t(23,`

          `),d(24,ho,43,15,"div",8),t(25,`
        `),a(),t(26,`
  ...
  `),a(),t(40,`
`),a(),t(41,`
`)),s&2&&(o(4),l("formGroup",r.savingsChargeForm),o(9),u(m(14,9,"labels.inputs.Charge")),o(5),l("ngForOf",r.savingsChargeOptions),o(3),l("ngIf",r.savingsChargeForm.controls.chargeId.hasError("required")),o(3),l("ngIf",r.chargeDetails),o(5),l("routerLink",B(15,co)),o(),v(`
            `,m(31,11,"labels.buttons.Cancel"),`
          `),o(3),l("disabled",!r.savingsChargeForm.valid),o(),v(`
            `,m(35,13,"labels.buttons.Submit"),`
          `))},dependencies:[T,Dt,N,y,at,nt,oe,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,Ft,wt,_t,Ct,xt,k,I],styles:[".container[_ngcontent-%COMP%]{width:37rem}"]})}}return e})();var So=()=>["../../transactions"];function bo(e,p){e&1&&(i(0,"h2",20),t(1),c(2,"translate"),a()),e&2&&(o(),v(`
      `,m(2,1,"labels.heading.Withdraw Money From Saving Account"),`
    `))}function Mo(e,p){e&1&&(i(0,"h2",20),t(1),c(2,"translate"),a()),e&2&&(o(),v(`
    ...
    `))}function Ao(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
              `,m(2,3,"labels.inputs.Transaction Date")," ",m(3,5,"labels.commons.is"),`
              `),o(4),u(m(6,7,"labels.commons.required")))}function To(e,p){if(e&1&&(i(0,"mat-option",21),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                `,n.name,`
              `)}}function yo(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
            `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
            `),f(6,"input",22),t(7,`
          `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Account Number")))}function Po(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
            `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
            `),f(6,"input",23),t(7,`
          ...
          `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Routing Code")))}function Do(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
            `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
            `),f(6,"input",25),t(7,`
          `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Receipt Number")))}function Oo(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
            `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
            `),f(6,"input",26),t(7,`
        ...
        `),i(12,"div",4),t(13,`
          ...
          `),i(33,"mat-form-field"),t(34,`
            ...
            `),i(39,"mat-select",10),t(40,`
              `),d(41,To,2,2,"mat-option",11),t(42,`
            `),a(),t(43,`
          `),a(),t(44,`
          ...
          `),d(63,Po,8,3,"mat-form-field",8),t(64,`

          `),d(65,Io,8,3,"mat-form-field",8),t(66,`

          `),d(67,Do,8,3,"mat-form-field",8),t(68,`

          `),d(69,Oo,8,3,"mat-form-field",8),t(70,`
...
`)}if(s&2){let g=O(25);o(4),l("ngIf",r.transactionType.withdrawal),o(2),l("ngIf",r.transactionType.deposit),o(2),l("formGroup",r.savingAccountTransactionForm),o(9),u(m(18,27,"labels.inputs.Transaction Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.savingAccountTransactionForm.controls.transactionDate.hasError("required")),o(3),l("currency",r.currency)("isRequired",!0)("inputFormControl",r.savingAccountTransactionForm.controls.transactionAmount)("inputLabel","Transaction Amount"),o(6),u(m(37,29,"labels.inputs.Payment Type")),o(5),l("ngForOf",r.paymentTypeOptions),o(10),l("className",r.addPaymentDetailsFlag?"enabled":"disabled"),o(3),u(m(55,31,"labels.inputs.Show Payment Details")),o(7),l("ngIf",r.addPaymentDetailsFlag),o(2),l("ngIf",r.addPaymentDetailsFlag),o(2),l("ngIf",r.addPaymentDetailsFlag),o(2),l("ngIf",r.addPaymentDetailsFlag),o(2),l("ngIf",r.addPaymentDetailsFlag),o(5),u(m(75,33,"labels.inputs.Notes")),o(8),l("routerLink",B(39,So)),o(),v(`
            ...
            `)}},dependencies:[T,Dt,N,y,at,nt,oe,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,Ft,wt,_t,Ct,xt,k,I,je,Fe,re],styles:[".expandcollapsebutton[_ngcontent-%COMP%]{margin-top:-7px}.container[_ngcontent-%COMP%]{max-width:37rem}.right-input[_ngcontent-%COMP%]{text-align:right}.right-label[_ngcontent-%COMP%]{padding-right:25px!important}"]})}}return e})();var Eo=()=>["../../"];function wo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
              `,m(2,3,"labels.inputs.Closed On Date")," ",m(3,5,"labels.commons.is"),`
              `),o(4),u(m(6,7,"labels.commons.required")))}function Fo(e,p){e&1&&(i(0,"mat-form-field",20),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",21),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Transaction Amount")))}function ko(e,p){if(e&1&&(i(0,"mat-option",24),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
                  `,n.name,`
                `)}}function Bo(e,p){if(e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),i(6,"mat-select",22),t(7,`
                `),d(8,ko,2,2,"mat-option",23),t(9,`
              `),a(),t(10,`
            `),a()),e&2){let n=C(2);o(3),u(m(4,2,"labels.inputs.Payment Type")),o(5),l("ngForOf",n.paymentTypeOptions)}}function No(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",25),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Account Number")))}function Ro(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",26),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Cheque")))}function Vo(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",27),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Routing Code")))}function Lo(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",28),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Receipt Number")))}function jo(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
              `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
              `),f(6,"input",29),t(7,`
            `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Bank")))}function Go(e,p){if(e&1){let n=P();i(0,"div",3),t(1,`
            `),d(2,Fo,8,3,"mat-form-field",15),t(3,`

            `),d(4,Bo,11,4,"mat-form-field",7),t(5,`
            ...
            `),d(22,No,8,3,"mat-form-field",7),t(23,`

            `),d(24,Ro,8,3,"mat-form-field",7),t(25,`

            `),d(26,Vo,8,3,"mat-form-field",7),t(27,`

            `),d(28,Lo,8,3,"mat-form-field",7),t(29,`

            `),d(30,jo,8,3,"mat-form-field",7),t(31,`
...
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.closeSavingsAccountForm),o(9),u(m(14,15,"labels.inputs.Closed On Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.closeSavingsAccountForm.controls.closedOnDate.hasError("required")),o(4),v(`
          ...
          `),o(3),l("ngIf",r.closeSavingsAccountForm.controls.withdrawBalance.value),o(5),u(m(40,21,"labels.inputs.Note")),o(10),l("routerLink",B(27,Eo)),o(),v(`
          `,m(51,23,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.closeSavingsAccountForm.valid),o(),v(`
          `,m(55,25,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,Dt,N,y,at,nt,oe,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,Ft,wt,_t,Ct,xt,k,I,xe,Fe,re],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var Uo=()=>["../../"];function qo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
              `,m(2,3,"labels.inputs.Due Date")," ",m(3,5,"labels.commons.is"),`
              `),o(4),u(m(6,7,"labels.commons.required")))}function Ho(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
            `),a()),e&2&&(o(),R(`
              `,m(2,3,"labels.inputs.Amount")," ",m(3,5,"labels.commons.is"),`
      ...
      `),i(6,"mat-card-content"),t(7,`
        `),i(8,"div",3),t(9,`
          `),i(10,"mat-form-field",4),h("click",function(){b(g);let S=O(21);return M(S.open())}),t(11,`
            ...
            `),f(18,"mat-datepicker-toggle",6),t(19,`
            `),f(20,"mat-datepicker",null,0),t(22,`
            `),d(23,qo,8,9,"mat-error",7),t(24,`
          `),a(),t(25,`

          `),i(26,"mat-form-field"),t(27,`
            `),i(28,"mat-label"),t(29),c(30,"translate"),a(),t(31,`
            `),f(32,"input",8),t(33,`
            `),d(34,Ho,8,9,"mat-error",7),t(35,`
          `),a(),t(36,`
        `),a(),t(37,`
      `),a(),t(38,`
  ...
  `),a(),t(51,`
`),a(),t(52,`
`)}if(s&2){let g=O(21);o(4),l("formGroup",r.applyAnnualFeesForm),o(9),u(m(14,13,"labels.inputs.Annual Fees Transaction Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.applyAnnualFeesForm.controls.dueDate.hasError("required")),o(6),u(m(30,15,"labels.inputs.Amount")),o(5),l("ngIf",r.applyAnnualFeesForm.controls.amount.hasError("required")),o(7),l("routerLink",B(21,Uo)),o(),v(`
          `,m(43,17,"labels.buttons.Cancel"),`
        `),o(3),l("disabled",!r.applyAnnualFeesForm.valid),o(),v(`
          `,m(47,19,"labels.buttons.Confirm"),`
        `)}},dependencies:[T,N,y,at,nt,oe,K,it,pt,ot,rt,G,J,ct,ht,Z,X,dt,vt,mt,_t,Ct,xt,k,I],styles:[".container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return e})();var zo=()=>["../../transactions"];function $o(e,p){e&1&&(i(0,"mat-card-title"),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.heading.Hold Amount")))}function Wo(e,p){e&1&&(i(0,"mat-card-title"),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.heading.Block Savings Account")))}function Qo(e,p){if(e&1&&(i(0,"mat-option",13),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
              `,n.name,`
            `)}}function Ko(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
          `),a()),e&2&&(o(),R(`
            `,m(2,3,"labels.inputs.Reason")," ",m(3,5,"labels.commons.is"),`
            `),o(4),u(m(6,7,"labels.commons.required")))}function Yo(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
          `),a()),e&2&&(o(),R(`
            `,m(2,3,"labels.inputs.Transaction Date")," ",m(3,5,"labels.commons.is"),`
            `),o(4),u(m(6,7,"labels.commons.required")))}function Jo(e,p){if(e&1){let n=P();i(0,"mat-form-field",14),h("click",function(){b(n);let r=O(11);return M(r.open())}),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",15),t(7,`
          `),f(8,"mat-datepicker-toggle",16),t(9,`
          `),f(10,"mat-datepicker",null,0),t(12,`
          `),d(13,Yo,8,9,"mat-error",2),t(14,`
        `),a()}if(e&2){let n=O(11),s=C();o(3),u(m(4,6,"labels.inputs.Transaction Date")),o(3),l("min",s.minDate)("max",s.maxDate)("matDatepicker",n),o(2),l("for",n),o(5),l("ngIf",s.manageSavingsAccountForm.controls.transactionDate.hasError("required"))}}function Xo(e,p){if(e&1&&(i(0,"mifosx-input-amount",17),t(1,`
  ...
  `),i(2,"mat-card"),t(3,`
    `),d(4,$o,3,3,"mat-card-title",2),t(5,`
    `),d(6,Wo,3,3,"mat-card-title",2),t(7,`
      ...
      `),i(10,"mat-card-content",4),t(11,`
        `),i(12,"mat-form-field",5),t(13,`
          ...
          `),i(18,"mat-select",6),t(19,`
            `),d(20,Qo,2,2,"mat-option",7),t(21,`
          `),a(),t(22,`
          `),d(23,Ko,8,9,"mat-error",2),t(24,`
        `),a(),t(25,`

        `),d(26,Jo,15,8,"mat-form-field",8),t(27,`

        `),d(28,Xo,2,4,"mifosx-input-amount",9),t(29,`
      `),a(),t(30,`
...
`),i(11,"mat-dialog-actions",2),t(12,`
  ...
  `),i(17,"button",4),t(18),c(19,"translate"),a(),t(20,`
`),a(),t(21,`
`)),s&2&&(o(),u(m(2,6,"labels.buttons.Waive Charge")),o(6),R("",m(8,8,"labels.text.Are you sure you want to waive charge with id"),": ",r.data.id," ?"),o(7),u(m(15,10,"labels.buttons.Cancel")),o(3),l("mat-dialog-close",B(14,dr)),o(),v(`
    `,m(19,12,"labels.buttons.Confirm"),`
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var ur=()=>({confirm:!0}),qe=(()=>{class e{constructor(n,s){this.dialogRef=n,this.data=s}static{this.\u0275fac=function(s){return new(s||e)(x(te),x(Ee))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-inactivate-charge-dialog"]],decls:22,vars:15,consts:[["mat-dialog-title",""],["mat-dialog-content",""],["align","end"],["mat-raised-button","","mat-dialog-close",""],["mat-raised-button","","color","primary",3,"mat-dialog-close"]],template:function(s,r){s&1&&(i(0,"h1",0),t(1),c(2,"translate"),a(),t(3,`
`),i(4,"div",1),t(5,`
  `),i(6,"p"),t(7),c(8,"translate"),a(),t(9,`
`),a(),t(10,`
`),i(11,"mat-dialog-actions",2),t(12,`
  ...
  `),i(17,"button",4),t(18),c(19,"translate"),a(),t(20,`
`),a(),t(21,`
`)),s&2&&(o(),u(m(2,6,"tooltips.Inactivate Charge")),o(6),R("",m(8,8,"labels.text.Are you sure you want to inactivate charge with id"),": ",r.data.id," ?"),o(7),u(m(15,10,"labels.buttons.Cancel")),o(3),l("mat-dialog-close",B(14,ur)),o(),v(`
    `,m(19,12,"labels.buttons.Confirm"),`
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var gr=["chargesTable"],fr=e=>[e];function vr(e,p){if(e&1){let n=P();i(0,"div",22),t(1,`
...
`)),s&2&&(o(7),u(m(8,5,"labels.inputs.Charges")),o(4),l("ngIf",r.chargesData),o(5),l("dataSource",r.dataSource),o(80),l("matHeaderRowDef",r.displayedColumns),o(2),l("matRowDefColumns",r.displayedColumns))},dependencies:[T,N,fe,y,G,k,Rt,Lt,I,Vt,Ut,zt,Ht,$t,qt,Wt,Ce,Qt,Yt,Kt,Jt],styles:[".tab-container[_ngcontent-%COMP%]{padding:1%;margin:1%}.tab-container[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:1% auto}.tab-container[_ngcontent-%COMP%]   .action-button[_ngcontent-%COMP%]{margin-left:auto}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   .account-action-button[_ngcontent-%COMP%]{min-width:26px;padding:0 6px;margin:4px;line-height:25px}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   .select-row[_ngcontent-%COMP%]:hover{cursor:pointer}"]})}}return e})();var Kr=["instructionsTable"];function Yr(e,p){e&1&&(i(0,"th",16),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Client")))}function Jr(e,p){if(e&1&&(i(0,"td",17),t(1),a()),e&2){let n=p.$implicit;o(),R(`
  ...
  `),i(9,"div",3),t(10,`
    `),i(11,"table",4,0),t(13,`
      `),E(14,5),t(15,`
        `),d(16,Yr,3,3,"th",6),t(17,`
        `),d(18,Jr,2,2,"td",7),t(19,`
      `),w(),t(20,`

      `),E(21,8),t(22,`
        `),d(23,Xr,3,3,"th",6),t(24,`
        `),d(25,Zr,2,2,"td",7),t(26,`
      `),w(),t(27,`

      `),E(28,9),t(29,`
        `),d(30,ts,3,3,"th",6),t(31,`
        `),d(32,es,2,1,"td",7),t(33,`
      `),w(),t(34,`

      `),E(35,10),t(36,`
        `),d(37,ns,3,3,"th",6),t(38,`
        `),d(39,is,2,2,"td",7),t(40,`
      `),w(),t(41,`

      `),E(42,11),t(43,`
        `),d(44,as,3,3,"th",6),t(45,`
        `),d(46,os,2,2,"td",7),t(47,`
      `),w(),t(48,`

      `),E(49,12),t(50,`
        `),d(51,rs,3,3,"th",6),t(52,`
        `),d(53,ss,5,9,"td",7),t(54,`
      `),w(),t(55,`

      `),E(56,13),t(57,`
        `),d(58,cs,3,3,"th",6),t(59,`
        `),d(60,gs,8,3,"td",7),t(61,`
      `),w(),t(62,`

      `),d(63,fs,1,0,"tr",14),t(64,`
      `),d(65,vs,1,0,"tr",15),t(66,`
    `),a(),t(67,`
  `),a(),t(68,`
`),a(),t(69,`
`)),s&2&&(o(5),u(m(6,4,"labels.heading.All Standing Instructions")),o(6),l("dataSource",r.dataSource),o(52),l("matHeaderRowDef",r.displayedColumns),o(2),l("matRowDefColumns",r.displayedColumns))},dependencies:[T,N,y,k,Rt,Lt,I,Ut,zt,Ht,$t,qt,Wt,Ce,Qt,Yt,Kt,Jt],styles:[".tab-container[_ngcontent-%COMP%]{padding:1%;margin:1%}.tab-container[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:1% auto}.tab-container[_ngcontent-%COMP%]   .action-button[_ngcontent-%COMP%]{margin-left:auto}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.tab-container[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   .account-action-button[_ngcontent-%COMP%]{min-width:26px;padding:0 6px;margin:4px;line-height:25px}"]})}}return e})();var Rn=(()=>{class e{constructor(n){this.route=n,this.entityId=this.route.parent.parent.snapshot.paramMap.get("savingAccountId"),this.route.data.subscribe(s=>{this.entityDatatable=s.savingsDatatable,this.multiRowDatatableFlag=this.entityDatatable.columnHeaders[0].columnName==="id"})}static{this.\u0275fac=function(s){return new(s||e)(x(F))}}static{this.\u0275cmp=A({type:e,selectors:[["mifosx-datatable-tabs"]],decls:6,vars:3,consts:[[1,"tab-container","mat-typography"],["entityType","Savings",3,"entityId","multiRowDatatableFlag","entityDatatable"]],template:function(s,r){s&1&&(i(0,"div",0),t(1,`
  ...
  `),a(),t(4,`
`),a(),t(5,`
`)),s&2&&(o(2),l("entityId",r.entityId)("multiRowDatatableFlag",r.multiRowDatatableFlag)("entityDatatable",r.entityDatatable))},dependencies:[T,y,un],encapsulation:2})}}return e})();function xs(e,p){if(e&1&&(i(0,"mat-option",13),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
          `,n.name,`
        `)}}function _s(e,p){if(e&1){let n=P();i(0,"mat-form-field",14),h("click",function(){b(n);let r=O(11);return M(r.open())}),t(1,`
      `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
      `),f(6,"input",15),t(7,`
      `),f(8,"mat-datepicker-toggle",16),t(9,`
      `),f(10,"mat-datepicker",null,0),t(12,`
    ...
    `),a()}if(e&2){let n=O(11),s=C();o(3),u(m(4,8,"labels.inputs.Submitted On")),o(3),l("min",s.minDate)("max",s.maxDate)("matDatepicker",n),o(2),l("for",n),o(6),R(`
        ...
        `),o(4),u(m(19,14,"labels.commons.required"))}}function Cs(e,p){if(e&1&&(i(0,"mat-option",13),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
          `,n.displayName,`
        `)}}function hs(e,p){if(e&1&&(i(0,"mat-form-field",3),t(1,`
      `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
      `),i(6,"mat-select",17),t(7,`
        `),d(8,Cs,2,2,"mat-option",5),t(9,`
      `),a(),t(10,`
  ...
  `),i(2,"div",2),t(3,`
    `),i(4,"mat-form-field",3),t(5,`
      ...
      `),i(10,"mat-select",4),t(11,`
        `),d(12,xs,2,2,"mat-option",5),t(13,`
      `),a(),t(14,`
      `),i(15,"mat-error"),t(16),c(17,"translate"),c(18,"translate"),i(19,"strong"),t(20),c(21,"translate"),a(),t(22,`
      `),a(),t(23,`
    `),a(),t(24,`

    `),d(25,_s,22,16,"mat-form-field",6),t(26,`

    `),d(27,hs,11,4,"mat-form-field",7),t(28,`
...
`)),s&2&&(l("formGroup",r.savingsAccountDetailsForm),o(7),u(m(8,12,"labels.inputs.Product Name")),o(5),l("ngForOf",r.productData),o(4),R(`
    ...
    `),o(3),l("disabled",r.savingsAccountDetailsForm.invalid),o(),v(`
      ...
      `))},dependencies:[T,Dt,N,y,at,nt,K,it,pt,ot,rt,Z,X,dt,vt,mt,Ft,wt,_t,Ct,xt,k,I,pe,St,he],encapsulation:2})}}return e})();function bs(e,p){if(e&1&&(i(0,"mat-option",28),t(1),c(2,"translateKey"),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
          `,bt(2,2,n.value,"catalogs"),`
        `)}}function Ms(e,p){if(e&1&&(i(0,"mat-option",28),t(1),c(2,"translateKey"),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
          `,bt(2,2,n.value,"catalogs"),`
        ...
        `)}}function ys(e,p){if(e&1&&(i(0,"mat-option",28),t(1),c(2,"translateKey"),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
          `,bt(2,2,n.value,"catalogs"),`
        `)}}function Ps(e,p){e&1&&(i(0,"div",29),t(1,`
  ...
  `),i(2,"div",1),t(3,`
    ...
    `),i(103,"mat-form-field",2),t(104,`
      ...
      `),i(109,"mat-select",10),t(110,`
        `),d(111,Ts,3,5,"mat-option",7),t(112,`
      `),a(),t(113,`
...
`)),s&2&&(l("formGroup",r.savingsAccountTermsForm),o(7),u(m(8,41,"labels.inputs.Currency")),o(9),u(m(17,43,"labels.inputs.Decimal Places")),o(9),u(m(26,45,"labels.inputs.Nominal Annual Interest")),o(6),R(`
    ...
    `),o(4),v(`
      ...
      `))},dependencies:[T,Dt,N,y,at,nt,oe,K,it,pt,ot,rt,Z,X,dt,mt,Ft,wt,k,I,Vt,xe,nn,pe,St,he],styles:["h4[_ngcontent-%COMP%]{font-weight:500;margin:1em 0}h3[_ngcontent-%COMP%]{font-weight:500}mat-divider[_ngcontent-%COMP%]{margin:1em 0 2em}.margin-v[_ngcontent-%COMP%]{margin:1em 0}.margin-b[_ngcontent-%COMP%]{margin:0 0 1em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();function Ds(e,p){if(e&1&&(i(0,"mat-option",13),t(1),a()),e&2){let n=p.$implicit;l("value",n),o(),v(`
        `,n.name,`
      `)}}function Os(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Name")))}function Es(e,p){if(e&1&&(i(0,"td",27),t(1),a()),e&2){let n=p.$implicit;o(),v(`
        `,n.name+", "+n.currency.displaySymbol,`
      `)}}function ws(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Type")))}function Fs(e,p){if(e&1&&(i(0,"td",27),t(1),a()),e&2){let n=p.$implicit;o(),v(`
        `,n.chargeCalculationType.value,`
      `)}}function ks(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Amount")))}function Bs(e,p){if(e&1){let n=P();i(0,"td",27),t(1),c(2,"formatNumber"),i(3,"button",28),h("click",function(){let r=b(n).$implicit,g=C(2);return M(g.editChargeAmount(r))}),t(4,`
          `),f(5,"fa-icon",29),t(6,`
        `),a(),t(7,`
      `),a()}if(e&2){let n=p.$implicit;o(),v(`
        `,m(2,1,n.amount),`
        `)}}function Ns(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Collected On")))}function Rs(e,p){if(e&1&&(i(0,"td",27),t(1),c(2,"translateKey"),a()),e&2){let n=p.$implicit;o(),v(`
        `,bt(2,1,n.chargeTimeType.value,"catalogs"),`
      `)}}function Vs(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Date")))}function Ls(e,p){if(e&1&&(i(0,"span"),t(1),c(2,"dateFormat"),a()),e&2){let n=C().$implicit;o(),v(`
          `,m(2,1,n.dueDate)||"Unassigned",`
        `)}}function js(e,p){if(e&1&&(i(0,"span"),t(1),c(2,"dateFormat"),a()),e&2){let n=C().$implicit;o(),v(`
          `,m(2,1,n.feeOnMonthDay)||"Unassigned",`
        `)}}function Gs(e,p){e&1&&(i(0,"span"),t(1,`
          N/A
        `),a())}function Us(e,p){if(e&1){let n=P();i(0,"button",28),h("click",function(){b(n);let r=C().$implicit,g=C(2);return M(g.editChargeDate(r))}),t(1,`
          `),f(2,"fa-icon",29),t(3,`
        `),a()}}function qs(e,p){if(e&1&&(i(0,"td",27),t(1,`
        `),d(2,Ls,3,3,"span",30),t(3,`
        `),d(4,js,3,3,"span",30),t(5,`
        `),d(6,Gs,2,0,"span",30),t(7,`
        `),d(8,Us,4,0,"button",31),t(9,`
      `),a()),e&2){let n=p.$implicit;o(2),l("ngIf",n.chargeTimeType.value==="Specified due date"||n.chargeTimeType.value==="Weekly Fee"),o(2),l("ngIf",n.chargeTimeType.value==="Monthly Fee"||n.chargeTimeType.value==="Annual Fee"),o(2),l("ngIf",!(n.chargeTimeType.value==="Monthly Fee"||n.chargeTimeType.value==="Annual Fee"||n.chargeTimeType.value==="Specified due date"||n.chargeTimeType.value==="Weekly Fee")),o(2),l("ngIf",n.chargeTimeType.value==="Weekly Fee"||n.chargeTimeType.value==="Monthly Fee"||n.chargeTimeType.value==="Annual Fee"||n.chargeTimeType.value==="Specified due date")}}function Hs(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Repayments Every")))}function zs(e,p){if(e&1&&(i(0,"span"),t(1),a()),e&2){let n=C().$implicit;o(),u(n.feeInterval)}}function $s(e,p){e&1&&(i(0,"span"),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Not Provided")))}function Ws(e,p){if(e&1){let n=P();i(0,"button",28),h("click",function(){b(n);let r=C().$implicit,g=C(2);return M(g.editChargeFeeInterval(r))}),t(1,`
          `),f(2,"fa-icon",29),t(3,`
        `),a()}}function Qs(e,p){if(e&1&&(i(0,"td",27),t(1,`
        `),d(2,zs,2,1,"span",30),t(3,`
        `),d(4,$s,3,3,"span",30),t(5,`
        `),d(6,Ws,4,0,"button",31),t(7,`
      `),a()),e&2){let n=p.$implicit;o(2),l("ngIf",n.feeInterval),o(2),l("ngIf",!n.feeInterval),o(2),l("ngIf",n.chargeTimeType.value==="Weekly Fee"||n.chargeTimeType.value==="Monthly Fee")}}function Ks(e,p){e&1&&(i(0,"th",26),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Actions")))}function Ys(e,p){if(e&1){let n=P();i(0,"td",27),t(1,`
        `),i(2,"button",32),h("click",function(){let r=b(n).$implicit,g=C(2);return M(g.deleteCharge(r))}),t(3,`
          `),f(4,"fa-icon",33),t(5,`
        `),a(),t(6,`
      `),a()}}function Js(e,p){e&1&&f(0,"tr",34)}function Xs(e,p){e&1&&f(0,"tr",35)}function Zs(e,p){if(e&1&&(i(0,"table",14),t(1,`
    `),E(2,15),t(3,`
      `),d(4,Os,3,3,"th",16),t(5,`
      `),d(6,Es,2,1,"td",17),t(7,`
    `),w(),t(8,`

    `),E(9,18),t(10,`
      `),d(11,ws,3,3,"th",16),t(12,`
      `),d(13,Fs,2,1,"td",17),t(14,`
    `),w(),t(15,`

    `),E(16,19),t(17,`
      `),d(18,ks,3,3,"th",16),t(19,`
      `),d(20,Bs,8,3,"td",17),t(21,`
    `),w(),t(22,`

    `),E(23,20),t(24,`
      `),d(25,Ns,3,3,"th",16),t(26,`
      `),d(27,Rs,3,4,"td",17),t(28,`
    `),w(),t(29,`

    `),E(30,21),t(31,`
      `),d(32,Vs,3,3,"th",16),t(33,`
      `),d(34,qs,10,4,"td",17),t(35,`
    `),w(),t(36,`

    `),E(37,22),t(38,`
      `),d(39,Hs,3,3,"th",16),t(40,`
      `),d(41,Qs,8,3,"td",17),t(42,`
    `),w(),t(43,`

    `),E(44,23),t(45,`
      `),d(46,Ks,3,3,"th",16),t(47,`
      `),d(48,Ys,7,0,"td",17),t(49,`
    `),w(),t(50,`

    `),d(51,Js,1,0,"tr",24),t(52,`
    `),d(53,Xs,1,0,"tr",25),t(54,`
  ...
  `),a(),t(41,`
`),a(),t(42,`
`)}if(s&2){let g=O(9);o(5),u(m(6,7,"labels.inputs.Charge")),o(6),l("ngForOf",Ci(12,9,r.chargeData,r.chargesDataSource,r.currencyCode.value)),o(7),l("disabled",!g.value),o(3),v(`
    ...
    `),o(4),v(`
      ...
      `)}},dependencies:[T,Dt,N,y,Z,X,Ft,wt,k,Rt,I,Vt,St,Ut,zt,Ht,$t,qt,Wt,Oe,Qt,Yt,Kt,Jt,pe,he,Oi,de],styles:["table[_ngcontent-%COMP%]{width:100%}.mat-elevation-z1[_ngcontent-%COMP%]{margin:1em 0 1.5em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();var tc=()=>["../.."];function ec(e,p){if(e&1&&(i(0,"span",6),t(1,`
      `),f(2,"mifosx-external-identifier",17),t(3,`
    `),a()),e&2){let n=C();o(2),gt("externalId",n.savingsAccount.externalId)}}function nc(e,p){e&1&&(i(0,"span",6),t(1),c(2,"translate"),a()),e&2&&(o(),v(`
      `,m(2,1,"labels.inputs.Unassigned"),`
    `))}function ic(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Client ID")))}function ac(e,p){if(e&1&&(i(0,"td",26),t(1),a()),e&2){let n=p.$implicit;o(),u(n.id)}}function oc(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Client Name")))}function rc(e,p){if(e&1&&(i(0,"td",26),t(1),a()),e&2){let n=p.$implicit;o(),u(n.displayName)}}function sc(e,p){e&1&&f(0,"tr",27)}function cc(e,p){e&1&&f(0,"tr",28)}function mc(e,p){if(e&1&&(E(0),t(1,`
    ...
    `),i(8,"div",6),t(9,`
      `),i(10,"table",18,0),t(12,`
        `),t(13,`
        `),E(14,19),t(15,`
          `),d(16,ic,3,3,"th",20),t(17,`
          `),d(18,ac,2,1,"td",21),t(19,`
        `),w(),t(20,`

        `),t(21,`
        `),E(22,22),t(23,`
          `),d(24,oc,3,3,"th",20),t(25,`
          `),d(26,rc,2,1,"td",21),t(27,`
        `),w(),t(28,`

        `),d(29,sc,1,0,"tr",23),t(30,`
        `),d(31,cc,1,0,"tr",24),t(32,`
      `),a(),t(33,`
    `),a(),t(34,`
  `),w()),e&2){let n=C();o(3),u(m(4,4,"labels.heading.Client Members")),o(7),l("dataSource",n.dataSource),o(19),l("matHeaderRowDef",n.membersDisplayedColumns),o(2),l("matRowDefColumns",n.membersDisplayedColumns)}}function lc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),c(8,"formatNumber"),a(),t(9,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Minimum Opening Balance"),":"),o(4),u(m(8,4,n.savingsAccount.minRequiredOpeningBalance))}}function pc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),c(8,"find"),a(),t(9,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Lock-in Period"),":"),o(4),u(n.getCatalogTranslation(n.savingsAccount.lockinPeriodFrequency+" "+et(8,4,n.savingsAccount.lockinPeriodFrequencyType,n.savingsAccountProductTemplate.lockinPeriodFrequencyTypeOptions,"id","value")))}}function dc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),c(8,"formatNumber"),a(),t(9,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Minimum Overdraft Required for Interest Calculation"),":"),o(4),u(m(8,4,n.savingsAccount.minOverdraftForInterestCalculation))}}function uc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),c(8,"formatNumber"),a(),t(9,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Nominal Annual Interest for Overdraft"),":"),o(4),v("",m(8,4,n.savingsAccount.nominalAnnualInterestRateOverdraft)," %")}}function gc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),c(8,"formatNumber"),a(),t(9,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Maximum Overdraft Amount Limit"),":"),o(4),u(m(8,4,n.savingsAccount.overdraftLimit))}}function fc(e,p){if(e&1&&(i(0,"div",4),t(1,`
    `),i(2,"span",5),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"span",6),t(7),a(),t(8,`
  `),a()),e&2){let n=C();o(3),v("",m(4,2,"labels.inputs.Minimum Balance"),":"),o(4),u(n.savingsAccount.minRequiredBalance)}}function vc(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Name")))}function xc(e,p){if(e&1&&(i(0,"td",26),t(1),a()),e&2){let n=p.$implicit;o(),v(`
          `,n.name+", "+n.currency.displaySymbol,`
        `)}}function _c(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Type")))}function Cc(e,p){if(e&1&&(i(0,"td",26),t(1),c(2,"translateKey"),a()),e&2){let n=p.$implicit;o(),v(`
          `,bt(2,1,n.chargeCalculationType.value,"catalogs"),`
        `)}}function hc(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Amount")))}function Sc(e,p){if(e&1&&(i(0,"td",26),t(1),c(2,"formatNumber"),a()),e&2){let n=p.$implicit;o(),v(`
          `,m(2,1,n.amount),`
        `)}}function bc(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Date")))}function Mc(e,p){if(e&1&&(i(0,"span"),t(1),c(2,"dateFormat"),a()),e&2){let n=C().$implicit;o(),v(`
            `,m(2,1,n.dueDate)||"Unassigned",`
          `)}}function Ac(e,p){if(e&1&&(i(0,"span"),t(1),c(2,"dateFormat"),a()),e&2){let n=C().$implicit;o(),v(`
            `,m(2,1,n.feeOnMonthDay)||"Unassigned",`
          `)}}function Tc(e,p){e&1&&(i(0,"span"),t(1,`
            N/A
          `),a())}function yc(e,p){if(e&1&&(i(0,"td",26),t(1,`
          `),d(2,Mc,3,3,"span",8),t(3,`
          `),d(4,Ac,3,3,"span",8),t(5,`
          `),d(6,Tc,2,0,"span",8),t(7,`
        ...
        `)}}function Dc(e,p){e&1&&(i(0,"th",25),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Collected On")))}function Oc(e,p){if(e&1&&(i(0,"td",26),t(1),a()),e&2){let n=p.$implicit;o(),v(`
          `,n.chargeTimeType.value,`
        `)}}function Ec(e,p){e&1&&f(0,"tr",27)}function wc(e,p){e&1&&f(0,"tr",28)}function Fc(e,p){if(e&1&&(i(0,"div",29),t(1,`
    `),i(2,"h3",2),t(3),c(4,"translate"),a(),t(5,`

    `),f(6,"mat-divider",3),t(7,`
    `),i(8,"table",30),t(9,`
      `),E(10,22),t(11,`
        `),d(12,vc,3,3,"th",20),t(13,`
        `),d(14,xc,2,1,"td",21),t(15,`
      `),w(),t(16,`

      `),E(17,31),t(18,`
        `),d(19,_c,3,3,"th",20),t(20,`
        `),d(21,Cc,3,4,"td",21),t(22,`
      `),w(),t(23,`

      `),E(24,32),t(25,`
        `),d(26,hc,3,3,"th",20),t(27,`
        `),d(28,Sc,3,3,"td",21),t(29,`
      `),w(),t(30,`

      `),E(31,33),t(32,`
        `),d(33,bc,3,3,"th",20),t(34,`
        `),d(35,yc,8,3,"td",21),t(36,`
      `),w(),t(37,`

      `),E(38,34),t(39,`
        `),d(40,Pc,3,3,"th",20),t(41,`
        `),d(42,Ic,2,1,"td",21),t(43,`
      `),w(),t(44,`

      `),E(45,35),t(46,`
        `),d(47,Dc,3,3,"th",20),t(48,`
        `),d(49,Oc,2,1,"td",21),t(50,`
      `),w(),t(51,`

      `),d(52,Ec,1,0,"tr",23),t(53,`
      `),d(54,wc,1,0,"tr",24),t(55,`
    `),a(),t(56,`
  ...
  `),i(30,"div",4),t(31,`
    ...
    `),d(36,ec,4,1,"span",7),t(37,`
    `),d(38,nc,3,3,"span",7),t(39,`
  `),a(),t(40,`
  ...
  `),d(52,mc,35,6,"ng-container",8),t(53,`
  ...
  `),d(161,dc,10,6,"div",10),t(162,`

  `),d(163,uc,10,6,"div",10),t(164,`

  `),d(165,gc,10,6,"div",10),t(166,`
  ...
  `),d(178,fc,9,4,"div",10),t(179,`

  `),d(180,Fc,57,6,"div",11),t(181,`
`),a(),t(182,`
...
`)),s&2&&(o(3),u(m(4,43,"labels.heading.Details")),o(8),u(m(12,45,"labels.inputs.Product")),o(4),u(et(16,47,r.savingsAccount.productId,r.savingsAccountTemplate.productOptions,"id","name")),o(7),u(m(23,52,"labels.inputs.Submitted On")),o(4),u(m(27,54,r.savingsAccount.submittedOnDate)),o(7),u(m(34,56,"labels.inputs.External Id")),o(3),l("ngIf",r.savingsAccount.externalId),o(2),l("ngIf",!r.savingsAccount.externalId),o(6),u(m(45,58,"labels.inputs.Field Officer")),o(4),u(et(49,60,r.savingsAccount.fieldOfficerId,r.savingsAccountProductTemplate.fieldOfficerOptions,"id","displayName")),o(4),l("ngIf",r.activeClientMembers),o(3),u(m(56,65,"labels.heading.Terms")),o(8),u(m(64,67,"labels.inputs.Currency")),o(4),u(r.savingsAccountTermsForm.get("currencyCode").value),o(6),u(m(74,69,"labels.inputs.Decimal Places")),o(4),u(r.savingsAccountTermsForm.get("decimal").value),o(6),v("",m(84,71,"labels.inputs.Nominal Annual Interest"),":"),o(4),v("",m(88,73,r.savingsAccount.nominalAnnualInterestRate)," %"),o(7),v("",m(95,75,"labels.inputs.Interest Compounding Period"),":"),o(4),u(r.getCatalogTranslation(et(99,77,r.savingsAccount.interestCompoundingPeriodType,r.savingsAccountProductTemplate.interestCompoundingPeriodTypeOptions,"id","value"))),o(7),v("",m(106,82,"labels.inputs.Interest Posting Period"),":"),o(4),u(r.getCatalogTranslation(et(110,84,r.savingsAccount.interestPostingPeriodType,r.savingsAccountProductTemplate.interestPostingPeriodTypeOptions,"id","value"))),o(7),v("",m(117,89,"labels.inputs.Interest Calculated using"),":"),o(4),u(r.getCatalogTranslation(et(121,91,r.savingsAccount.interestCalculationType,r.savingsAccountProductTemplate.interestCalculationTypeOptions,"id","value"))),o(7),v("",m(128,96,"labels.inputs.Days in Year"),":"),o(4),u(r.getCatalogTranslation(et(132,98,r.savingsAccount.interestCalculationDaysInYearType,r.savingsAccountProductTemplate.interestCalculationDaysInYearTypeOptions,"id","value"))),o(4),l("ngIf",r.savingsAccount.minRequiredOpeningBalance),o(5),v("",m(141,103,"labels.inputs.Apply Withdrawal Fee for Transfers"),":"),o(4),u(m(145,105,r.savingsAccount.withdrawalFeeForTransfers)),o(4),l("ngIf",r.savingsAccount.lockinPeriodFrequency),o(5),v("",m(154,107,"labels.inputs.Is Overdraft Allowed"),":"),o(4),u(m(158,109,r.savingsAccount.allowOverdraft)),o(4),l("ngIf",r.savingsAccount.minOverdraftForInterestCalculation),o(2),l("ngIf",r.savingsAccount.nominalAnnualInterestRateOverdraft),o(2),l("ngIf",r.savingsAccount.overdraftLimit),o(5),v("",m(171,111,"labels.inputs.Enforce Minimum Balance"),":"),o(4),u(m(175,113,r.savingsAccount.enforceMinRequiredBalance)),o(4),l("ngIf",r.savingsAccount.minRequiredBalance),o(2),l("ngIf",r.savingsAccount.charges.length),o(8),v(`
  ...
  `))},dependencies:[T,N,y,G,k,Rt,I,Vt,nn,Ve,Ut,zt,Ht,$t,qt,Wt,Qt,Yt,Kt,Jt,pe,St,Ei,de,dn],styles:["table[_ngcontent-%COMP%]{width:100%}.mat-elevation-z1[_ngcontent-%COMP%]{margin:1em 0 1.5em}h2[_ngcontent-%COMP%], h3[_ngcontent-%COMP%], h4[_ngcontent-%COMP%]{margin:0;font-weight:500}span[_ngcontent-%COMP%]{margin:.5em 0}mat-divider[_ngcontent-%COMP%]{margin:0 0 .5em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();function kc(e,p){e&1&&(t(0,`
    ...
    `))}function Vc(e,p){e&1&&(t(0,`
      `),f(1,"fa-icon",17),t(2,`
    `))}function Lc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.DETAILS"))}function jc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.TERMS"))}function Gc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.CHARGES"))}function Uc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.PREVIEW"))}function qc(e,p){if(e&1){let n=P();i(0,"mat-step",18),t(1,`
      `),d(2,Uc,2,3,"ng-template",9),t(3,`
  ...
  `),i(2,"mat-horizontal-stepper",2,0),t(4,`
    `),d(5,kc,3,0,"ng-template",3),t(6,`

    `),d(7,Bc,3,0,"ng-template",4),t(8,`

    `),d(9,Nc,3,0,"ng-template",5),t(10,`

    `),d(11,Rc,3,0,"ng-template",6),t(12,`

    `),d(13,Vc,3,0,"ng-template",7),t(14,`

    `),i(15,"mat-step",8),t(16,`
      `),d(17,Lc,2,3,"ng-template",9),t(18,`
...
`)}s&2&&(o(15),l("stepControl",r.savingsAccountDetailsForm),o(4),l("savingsAccountTemplate",r.savingsAccountTemplate),o(4),l("stepControl",r.savingsAccountTermsForm),o(4),l("savingsAccountProductTemplate",r.savingsAccountProductTemplate),o(7),l("savingsAccountProductTemplate",r.savingsAccountProductTemplate)("savingsAccountTemplate",r.savingsAccountTemplate)("currencyCode",r.savingsAccountTermsForm.get("currencyCode")),o(4),l("ngIf",r.savingsAccountFormValid))},dependencies:[T,N,y,I,Re,Be,St,Ne,ke,se,ce,me,Me],encapsulation:2})}}return e})();function Hc(e,p){e&1&&(t(0,`
    ...
    `))}function Qc(e,p){e&1&&(t(0,`
      `),f(1,"fa-icon",16),t(2,`
    `))}function Kc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.DETAILS"))}function Yc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.TERMS"))}function Jc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.CHARGES"))}function Xc(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.PREVIEW"))}function Zc(e,p){if(e&1){let n=P();i(0,"mat-step",17),t(1,`
      `),d(2,Xc,2,3,"ng-template",9),t(3,`
  ...
  `),i(2,"mat-horizontal-stepper",2,0),t(4,`
    `),d(5,Hc,3,0,"ng-template",3),t(6,`

    `),d(7,zc,3,0,"ng-template",4),t(8,`

    `),d(9,$c,3,0,"ng-template",5),t(10,`

    `),d(11,Wc,3,0,"ng-template",6),t(12,`

    `),d(13,Qc,3,0,"ng-template",7),t(14,`

    `),i(15,"mat-step",8),t(16,`
      `),d(17,Kc,2,3,"ng-template",9),t(18,`
...
`)}s&2&&(o(15),l("stepControl",r.savingsAccountDetailsForm),o(4),l("savingsAccountTemplate",r.savingsAccountAndTemplate),o(4),l("stepControl",r.savingsAccountTermsForm),o(4),l("savingsAccountProductTemplate",r.savingsAccountProductTemplate)("savingsAccountTemplate",r.savingsAccountAndTemplate),o(7),l("savingsAccountProductTemplate",r.savingsAccountProductTemplate)("savingsAccountTemplate",r.savingsAccountAndTemplate)("currencyCode",r.savingsAccountTermsForm.get("currencyCode")),o(4),l("ngIf",r.savingsAccountFormValidAndNotPristine))},dependencies:[T,N,y,I,Re,Be,St,Ne,ke,se,ce,me,Me],encapsulation:2})}}return e})();var tm=()=>["./general"],em=e=>["./datatables",e];function nm(e,p){if(e&1&&(i(0,"a",5,2),t(2),a()),e&2){let n=O(1),s=C().$implicit;l("routerLink",Nt(3,em,s.registeredTableName))("active",n.isActive),o(2),v(`
        `,s.registeredTableName,`
      `)}}function im(e,p){if(e&1&&(E(0),t(1,`
      `),d(2,nm,3,5,"a",7),t(3,`
  ...
  `),i(2,"nav",4),t(3,`
    ...
    `),d(9,im,4,1,"ng-container",6),t(10,`
  `),a(),t(11,`
...
`)}if(s&2){let g=O(15),_=O(38);l("formGroup",r.transactionsReportForm),o(7),u(m(8,22,"labels.inputs.From Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(6),R(`
        ...
        `),o(4),u(m(46,36,"labels.commons.required")),o(8),l("routerLink",B(42,vm)),o(),u(m(55,38,"labels.buttons.Cancel")),o(3),l("disabled",!r.transactionsReportForm.valid),o(3),v("",m(61,40,"labels.buttons.Generate Report"),` \xA0
    `),o(5),l("ngIf",!r.hideOutput)}},dependencies:[T,N,y,at,nt,K,it,pt,ot,rt,G,Z,X,dt,vt,mt,_t,Ct,xt,k,I,St],styles:[".generate-button[_ngcontent-%COMP%]{max-height:2%;padding:1% 0 2% 6%;align-self:center}"]})}}return e})();var _m=()=>["../"];function Cm(e,p){e&1&&(i(0,"mat-error"),t(1),c(2,"translate"),c(3,"translate"),i(4,"strong"),t(5),c(6,"translate"),a(),t(7,`
          `),a()),e&2&&(o(),R(`
            `,m(2,3,"labels.inputs.Transaction Date")," ",m(3,5,"labels.commons.is"),`
            `),o(4),u(m(6,7,"labels.commons.required")))}function hm(e,p){if(e&1&&(i(0,"mat-option",18),t(1),a()),e&2){let n=p.$implicit;l("value",n.id),o(),v(`
              `,n.name,`
            `)}}function Sm(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",19),t(7,`
        `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Account Number")))}function bm(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",20),t(7,`
        `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Cheque")))}function Mm(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",21),t(7,`
        `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Routing Code")))}function Am(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",22),t(7,`
        `),a()),e&2&&(o(3),u(m(4,1,"labels.inputs.Receipt Number")))}function Tm(e,p){e&1&&(i(0,"mat-form-field"),t(1,`
          `),i(2,"mat-label"),t(3),c(4,"translate"),a(),t(5,`
          `),f(6,"input",23),t(7,`
      ...
      `),i(6,"mat-card-content",3),t(7,`
        ...
        `),i(27,"mat-form-field"),t(28,`
          ...
          `),i(33,"mat-select",9),t(34,`
            `),d(35,hm,2,2,"mat-option",10),t(36,`
          `),a(),t(37,`
        `),a(),t(38,`
        ...
        `),d(57,bm,8,3,"mat-form-field",7),t(58,`

        `),d(59,Mm,8,3,"mat-form-field",7),t(60,`

        `),d(61,Am,8,3,"mat-form-field",7),t(62,`

        `),d(63,Tm,8,3,"mat-form-field",7),t(64,`
...
`)}if(s&2){let g=O(19);o(4),l("formGroup",r.editTransactionForm),o(7),u(m(12,24,"labels.inputs.Transaction Date")),o(3),l("min",r.minDate)("max",r.maxDate)("matDatepicker",g),o(2),l("for",g),o(5),l("ngIf",r.editTransactionForm.controls.transactionDate.hasError("required")),o(3),l("currency",r.currency)("isRequired",!0)("inputFormControl",r.editTransactionForm.controls.transactionAmount)("inputLabel","Transaction Amount"),o(6),u(m(31,26,"labels.inputs.Payment Type")),o(5),l("ngForOf",r.paymentTypeOptions),o(10),l("className",r.showPaymentDetails?"enabled":"disabled"),o(3),u(m(49,28,"labels.inputs.Show Payment Details")),o(7),l("ngIf",r.editTransactionForm.controls.accountNumber),o(2),l("ngIf",r.editTransactionForm.controls.checkNumber),o(2),l("ngIf",r.editTransactionForm.controls.routingCode),o(2),l("ngIf",r.editTransactionForm.controls.receiptNumber),o(2),l("ngIf",r.editTransactionForm.controls.bankNumber),o(4),l("routerLink",B(34,_m)),o(),v(`
      ...
      `),a()}if(e&2){let n=C(2);o(2),Zn("ngModel",n.selectAllItems)}}function Pm(e,p){if(e&1){let n=P();i(0,"td",16),t(1,`
...
`)),s&2&&(l("ngIf",r.activeClientMembers),o(7),v(`
  ...
  `),o(3),l("disabled",r.selectedClientMembers.selectedMembers.length===0),o(),v(`
    ...
    `))},dependencies:[T,N,y,K,k,I,Ut,zt,Ht,$t,xe,Mi,Si,qt,Wt,Qt,Yt,Kt,Jt,pe,St,he],styles:["table[_ngcontent-%COMP%]{width:100%}.mat-elevation-z1[_ngcontent-%COMP%]{margin:1em 0 1.5em}.margin-t[_ngcontent-%COMP%]{margin-top:1em}"]})}}return e})();function Bm(e,p){e&1&&(t(0,`
      `),f(1,"fa-icon",15),t(2,`
    `))}function Nm(e,p){e&1&&(t(0,`
      `),f(1,"fa-icon",15),t(2,`
    ...
    `))}function Lm(e,p){e&1&&(t(0,`
      `),f(1,"fa-icon",18),t(2,`
    `))}function jm(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.DETAILS"))}function Gm(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.TERMS"))}function Um(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.CHARGES"))}function qm(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.heading.Active Client Members"))}function Hm(e,p){e&1&&(t(0),c(1,"translate")),e&2&&u(m(1,1,"labels.inputs.PREVIEW"))}function zm(e,p){if(e&1){let n=P();i(0,"mat-step",19),t(1,`
      `),d(2,Hm,2,3,"ng-template",9),t(3,`
  ...
  `),i(2,"mat-horizontal-stepper",2,0),t(4,`
    `),d(5,Bm,3,0,"ng-template",3),t(6,`

    `),d(7,Nm,3,0,"ng-template",4),t(8,`

    `),d(9,Rm,3,0,"ng-template",5),t(10,`

    `),d(11,Vm,3,0,"ng-template",6),t(12,`

    `),d(13,Lm,3,0,"ng-template",7),t(14,`

    `),i(15,"mat-step",8),t(16,`
      `),d(17,jm,2,3,"ng-template",9),t(18,`
    ...
    `),i(23,"mat-step",8),t(24,`
      `),d(25,Gm,2,3,"ng-template",9),t(26,`

      `),f(27,"mifosx-savings-account-terms-step",11),t(28,`
    `),a(),t(29,`

    `),i(30,"mat-step"),t(31,`
      `),d(32,Um,2,3,"ng-template",9),t(33,`
...
`),i(11,"mat-dialog-actions",2),t(12,`
  ...
  `),i(17,"button",4),t(18),c(19,"translate"),a(),t(20,`
`),a(),t(21,`
`)),s&2&&(o(),u(m(2,5,"labels.heading.Release Amount")),o(6),u(m(8,7,"labels.text.Are you sure you want to release this amount")),o(7),u(m(15,9,"labels.buttons.Cancel")),o(3),l("mat-dialog-close",B(13,vl)),o(),v(`
    `,m(19,11,"labels.buttons.Confirm"),`
  `))},dependencies:[T,y,k,I,ne,ie,ae,ee],encapsulation:2})}}return e})();var xl=()=>["../../"];function _l(e,p){e&1&&(i(0,"button",14),t(1,`
        `),f(2,"fa-icon",15),t(3),c(4,"translate"),a()),e&2&&(l("routerLink","edit"),o(3),v("",m(4,2,"labels.buttons.Edit"),`
      `))}function Cl(e,p){if(e&1&&(i(0,"span"),t(1,`
      `),d(2,_l,5,4,"button",13),t(3,`
    `),a()),e&2){let n=C(2);o(2),l("ngIf",n.transactionData.transactionType.value==="Transfer"||n.transactionData.reversed==="true"||n.transactionData.transactionType.id===3||n.transactionData.transactionType.id===17)}}function hl(e,p){e&1&&(i(0,"span"),t(1,`
    `),d(2,Cl,4,1,"span",12),t(3,`
  `),a()),e&2&&(o(2),l("mifosxHasPermission","ADJUSTTRANSACTION_SAVINGSACCOUNT"))}function Sl(e,p){if(e&1){let n=P();i(0,"button",17),h("click",function(){b(n);let r=C(2);return M(r.releaseAmount())}),t(1,`
      `),f(2,"fa-icon",18),t(3),c(4,"translate"),a()}e&2&&(o(3),v("",m(4,1,"labels.buttons.Release Amount"),`
    `))}function bl(e,p){e&1&&(i(0,"span"),t(1,`
    `),d(2,Sl,5,3,"button",16),t(3,`
  `),a()),e&2&&(o(2),l("mifosxHasPermission","RELEASEAMOUNT_SAVINGSACCOUNT"))}function Ml(e,p){if(e&1){let n=P();i(0,"button",20),h("click",function(){b(n);let r=C(2);return M(r.undoTransaction())}),t(1,`
      `),f(2,"fa-icon",21),t(3),c(4,"translate"),a()}e&2&&(o(3),v("",m(4,1,"labels.buttons.Undo"),`
    `))}function Al(e,p){e&1&&(i(0,"span"),t(1,`
    `),d(2,Ml,5,3,"button",19),t(3,`
  `),a()),e&2&&(o(2),l("mifosxHasPermission","UNDOTRANSACTION_SAVINGSACCOUNT"))}function Tl(e,p){e&1&&(i(0,"div",5),t(1),c(2,"translate"),a()),e&2&&(o(),v(`
          `,m(2,1,"labels.inputs.Note"),`
        `))}function yl(e,p){if(e&1&&(i(0,"div",6),t(1),a()),e&2){let n=C();o(),v(`
          `,n.transactionData.note,`
        `)}}function Pl(e,p){if(e&1&&(i(0,"mifosx-transaction-payment-detail",22),t(1,`
  ...
  `),d(2,hl,4,1,"span",1),t(3,`
  `),d(4,bl,4,1,"span",1),t(5,`
  `),d(6,Al,4,1,"span",1),t(7,`
`),a(),t(8,`
  ...
  `),i(11,"mat-card"),t(12,`
    `),i(13,"mat-card-content"),t(14,`
      `),i(15,"div",3),t(16,`
        ...
        `),d(57,Tl,3,3,"div",7),t(58,`

        `),d(59,yl,2,1,"div",8),t(60,`

        `),d(61,Pl,2,1,"mifosx-transaction-payment-detail",9),t(62,`
      `),a(),t(63,`
...
`)),s&2&&(o(2),l("ngIf",!(r.transactionData.interestedPostedAsOn===!1&&(r.transactionData.transactionType.id===17||r.transactionData.transactionType.id===3))),o(2),l("ngIf",!r.transactionData.reversed&&r.transactionData.transactionType.amountHold),o(2),l("ngIf",r.allowUndo()),o(11),l("ngClass",r.transactionColor()),o(3),v(`
        ...
        `),o(3),l("ngIf",r.transactionData.note),o(2),l("ngIf",r.transactionData.note),o(2),l("ngIf",r.transactionData.paymentDetailData),o(5),l("routerLink",B(41,xl)),o(),v(`
          `,m(68,39,"labels.buttons.Back"),`
        `))},dependencies:[T,ge,N,fe,y,G,J,ct,k,Rt,Lt,I,Vt,St,Ri],styles:["body[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr[_ngcontent-%COMP%]:nth-child(2n){background-color:#f2f2f2}.bg-black[_ngcontent-%COMP%]{background-color:#000}.bg-light-grey[_ngcontent-%COMP%]{background-color:#e5e5e5}.bg-medium-grey[_ngcontent-%COMP%]{background-color:#ccc}.bg-grey[_ngcontent-%COMP%]{background-color:#999}.bg-dark-grey[_ngcontent-%COMP%]{background-color:#222}.bg-white[_ngcontent-%COMP%], .bg-fff[_ngcontent-%COMP%]{background-color:#fff}.bg-none[_ngcontent-%COMP%], .no-bg[_ngcontent-%COMP%]{background:none;background-image:none;background-color:transparent}.bg-facebook[_ngcontent-%COMP%]{background-color:#47639e}.bg-twitter[_ngcontent-%COMP%]{background-color:#02a8f3}body[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{border:1px solid rgba(0,0,0,.12)}.no-border[_ngcontent-%COMP%]{border:none}.no-border-t[_ngcontent-%COMP%]{border-top:none}.no-border-r[_ngcontent-%COMP%]{border-right:none}.no-border-b[_ngcontent-%COMP%]{border-bottom:none}.no-border-l[_ngcontent-%COMP%]{border-left:none}.no-border-lr[_ngcontent-%COMP%], .no-border-rl[_ngcontent-%COMP%]{border-left:none;border-right:none}.no-border-tb[_ngcontent-%COMP%], .no-border-bt[_ngcontent-%COMP%]{border-top:none;border-bottom:none}.no-border-tl[_ngcontent-%COMP%], .no-border-lt[_ngcontent-%COMP%]{border-top:none;border-left:none}.no-border-tr[_ngcontent-%COMP%], .no-border-rt[_ngcontent-%COMP%]{border-top:none;border-right:none}.no-border-bl[_ngcontent-%COMP%], .no-border-lb[_ngcontent-%COMP%]{border-bottom:none;border-left:none}.no-border-br[_ngcontent-%COMP%], .no-border-rb[_ngcontent-%COMP%]{border-bottom:none;border-right:none}.border-dashed[_ngcontent-%COMP%], .border-dotted[_ngcontent-%COMP%]{border-style:dashed}.border-black[_ngcontent-%COMP%]{border-color:#000}.border-light-grey[_ngcontent-%COMP%]{border-color:#e5e5e5}.border-medium-grey[_ngcontent-%COMP%]{border-color:#ccc}.border-grey[_ngcontent-%COMP%]{border-color:#999}.border-dark-grey[_ngcontent-%COMP%]{border-color:#2222}.border-white[_ngcontent-%COMP%], .border-fff[_ngcontent-%COMP%]{border-color:#fff}.no-border-radius[_ngcontent-%COMP%]{border-radius:0}.radius3[_ngcontent-%COMP%]{border-radius:3px}.radius5[_ngcontent-%COMP%]{border-radius:5px}.radius10[_ngcontent-%COMP%]{border-radius:10px}.column-mandatory[_ngcontent-%COMP%]{color:#5cb85c;text-align:center}.not-column-mandatory[_ngcontent-%COMP%]{color:#666f73;text-align:center}.cdk-drag-placeholder[_ngcontent-%COMP%]{background:#3498db}.yes[_ngcontent-%COMP%]{color:#5cb85c!important;background-color:#5cb85c;height:4px;cursor:none}.no[_ngcontent-%COMP%]{color:red;background-color:red;height:4px;cursor:none}.strike[_ngcontent-%COMP%]{text-decoration:line-through;color:red}.transfer[_ngcontent-%COMP%]{color:#16a085}.linked[_ngcontent-%COMP%]{color:#4461e2}.accrual[_ngcontent-%COMP%]{color:#999}.fa-question[_ngcontent-%COMP%]{color:#4461e2}.enabled[_ngcontent-%COMP%]{color:#32cd32}.disabled[_ngcontent-%COMP%]{color:#f44366}.v-mid[_ngcontent-%COMP%], .v-m[_ngcontent-%COMP%]{vertical-align:middle}.v-top[_ngcontent-%COMP%], .v-t[_ngcontent-%COMP%]{vertical-align:top}.v-bottom[_ngcontent-%COMP%], .v-b[_ngcontent-%COMP%]{vertical-align:bottom}.v-super[_ngcontent-%COMP%]{vertical-align:super}.r-amount[_ngcontent-%COMP%]{text-align:right!important;padding-right:5px!important}.left[_ngcontent-%COMP%]{text-align:left!important}.right[_ngcontent-%COMP%]{text-align:right!important}.center[_ngcontent-%COMP%]{text-align:center!important}.amount-plus[_ngcontent-%COMP%]{color:#000}.amount-minus[_ngcontent-%COMP%]{color:#4461e2}.block[_ngcontent-%COMP%]{display:block}.inline[_ngcontent-%COMP%]{display:inline}.in-block[_ngcontent-%COMP%]{display:inline-block;zoom:1}.d-none[_ngcontent-%COMP%], .hide[_ngcontent-%COMP%], .hidden[_ngcontent-%COMP%]{display:none}.t-0[_ngcontent-%COMP%]{top:0}.b-0[_ngcontent-%COMP%]{bottom:0}.l-0[_ngcontent-%COMP%]{left:0}.r-0[_ngcontent-%COMP%]{right:0}.tb-0[_ngcontent-%COMP%]{top:0;bottom:0}.lr-0[_ngcontent-%COMP%]{left:0;right:0}.f-left[_ngcontent-%COMP%]{float:left}.f-right[_ngcontent-%COMP%]{float:right}.f-none[_ngcontent-%COMP%]{float:none}textarea[_ngcontent-%COMP%]{resize:both}textarea.vertical[_ngcontent-%COMP%], textarea.horizontal[_ngcontent-%COMP%]{resize:vertical}textarea.noresize[_ngcontent-%COMP%]{resize:none}.full-input[_ngcontent-%COMP%]   input[_ngcontent-%COMP%], .full-input[_ngcontent-%COMP%]   select[_ngcontent-%COMP%], .full-input[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]{width:100%}.normal[_ngcontent-%COMP%]   input[_ngcontent-%COMP%], .normal[_ngcontent-%COMP%]   select[_ngcontent-%COMP%], .normal[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%], .full-input[_ngcontent-%COMP%]   [type=checkbox][_ngcontent-%COMP%], .full-input[_ngcontent-%COMP%]   [type=radio][_ngcontent-%COMP%]{width:auto}.mat-tab-body-content[_ngcontent-%COMP%]{margin-bottom:20px}.mat-datepicker-input[_ngcontent-%COMP%]{margin-top:5px;margin-bottom:5px}.loader-wrapper[_ngcontent-%COMP%]{height:100vh;width:100vw}.loader-wrapper[_ngcontent-%COMP%]   .triangle[_ngcontent-%COMP%]{width:0;height:0;border-style:solid;position:absolute;animation:_ngcontent-%COMP%_rotate .8s infinite .2s}.loader-wrapper[_ngcontent-%COMP%]   .bottom[_ngcontent-%COMP%]{border-width:0 90px 90px;border-color:transparent transparent #1fb050;bottom:calc(50% - 100px);left:calc(50% - 90px)}.loader-wrapper[_ngcontent-%COMP%]   .top[_ngcontent-%COMP%]{border-width:90px 90px 0;border-color:#b4d575 transparent transparent;top:calc(50% - 100px);left:calc(50% - 90px)}.loader-wrapper[_ngcontent-%COMP%]   .left[_ngcontent-%COMP%]{border-width:90px 0 90px 90px;border-color:transparent transparent transparent #1074b9;top:calc(50% - 90px);left:calc(50% - 100px)}.loader-wrapper[_ngcontent-%COMP%]   .right[_ngcontent-%COMP%]{border-width:90px 90px 90px 0;border-color:transparent #1daeec transparent transparent;top:calc(50% - 90px);right:calc(50% - 100px)}@keyframes _ngcontent-%COMP%_rotate{0%{transform:rotate(0)}to{transform:rotate(360deg)}}body[_ngcontent-%COMP%]{margin:0}.container[_ngcontent-%COMP%]{margin:0 auto}.mb-05[_ngcontent-%COMP%]{margin-bottom:.5rem}.mr-05[_ngcontent-%COMP%]{margin-right:.5rem}.mb-1[_ngcontent-%COMP%]{margin-bottom:1rem}.mt-1[_ngcontent-%COMP%]{margin-top:1rem}.m-5[_ngcontent-%COMP%]{margin:5px}.m-t-5[_ngcontent-%COMP%]{margin-top:5px}.m-r-5[_ngcontent-%COMP%]{margin-right:5px}.m-b-5[_ngcontent-%COMP%]{margin-bottom:5px}.m-l-5[_ngcontent-%COMP%]{margin-left:5px}.m-v-5[_ngcontent-%COMP%]{margin:5px 0}.m-h-5[_ngcontent-%COMP%]{margin:0 5px}.m-10[_ngcontent-%COMP%]{margin:10px}.m-t-10[_ngcontent-%COMP%]{margin-top:10px}.m-r-10[_ngcontent-%COMP%]{margin-right:10px}.m-b-10[_ngcontent-%COMP%]{margin-bottom:10px}.m-l-10[_ngcontent-%COMP%]{margin-left:10px}.m-v-10[_ngcontent-%COMP%]{margin:10px 0}.m-h-10[_ngcontent-%COMP%]{margin:0 10px}.m-15[_ngcontent-%COMP%]{margin:15px}.m-t-15[_ngcontent-%COMP%]{margin-top:15px}.m-r-15[_ngcontent-%COMP%]{margin-right:15px}.m-b-15[_ngcontent-%COMP%]{margin-bottom:15px}.m-l-15[_ngcontent-%COMP%]{margin-left:15px}.m-v-15[_ngcontent-%COMP%]{margin:15px 0}.m-h-15[_ngcontent-%COMP%]{margin:0 15px}.m-20[_ngcontent-%COMP%]{margin:20px}.m-t-20[_ngcontent-%COMP%]{margin-top:20px}.m-r-20[_ngcontent-%COMP%]{margin-right:20px}.m-b-20[_ngcontent-%COMP%]{margin-bottom:20px}.m-l-20[_ngcontent-%COMP%]{margin-left:20px}.m-v-20[_ngcontent-%COMP%]{margin:20px 0}.m-h-20[_ngcontent-%COMP%]{margin:0 20px}.m-25[_ngcontent-%COMP%]{margin:25px}.m-t-25[_ngcontent-%COMP%]{margin-top:25px}.m-r-25[_ngcontent-%COMP%]{margin-right:25px}.m-b-25[_ngcontent-%COMP%]{margin-bottom:25px}.m-l-25[_ngcontent-%COMP%]{margin-left:25px}.m-v-25[_ngcontent-%COMP%]{margin:25px 0}.m-h-25[_ngcontent-%COMP%]{margin:0 25px}.m-30[_ngcontent-%COMP%]{margin:30px}.m-t-30[_ngcontent-%COMP%]{margin-top:30px}.m-r-30[_ngcontent-%COMP%]{margin-right:30px}.m-b-30[_ngcontent-%COMP%]{margin-bottom:30px}.m-l-30[_ngcontent-%COMP%]{margin-left:30px}.m-v-30[_ngcontent-%COMP%]{margin:30px 0}.m-h-30[_ngcontent-%COMP%]{margin:0 30px}.m-35[_ngcontent-%COMP%]{margin:35px}.m-t-35[_ngcontent-%COMP%]{margin-top:35px}.m-r-35[_ngcontent-%COMP%]{margin-right:35px}.m-b-35[_ngcontent-%COMP%]{margin-bottom:35px}.m-l-35[_ngcontent-%COMP%]{margin-left:35px}.m-v-35[_ngcontent-%COMP%]{margin:35px 0}.m-h-35[_ngcontent-%COMP%]{margin:0 35px}.m-40[_ngcontent-%COMP%]{margin:40px}.m-t-40[_ngcontent-%COMP%]{margin-top:40px}.m-r-40[_ngcontent-%COMP%]{margin-right:40px}.m-b-40[_ngcontent-%COMP%]{margin-bottom:40px}.m-l-40[_ngcontent-%COMP%]{margin-left:40px}.m-v-40[_ngcontent-%COMP%]{margin:40px 0}.m-h-40[_ngcontent-%COMP%]{margin:0 40px}.m-45[_ngcontent-%COMP%]{margin:45px}.m-t-45[_ngcontent-%COMP%]{margin-top:45px}.m-r-45[_ngcontent-%COMP%]{margin-right:45px}.m-b-45[_ngcontent-%COMP%]{margin-bottom:45px}.m-l-45[_ngcontent-%COMP%]{margin-left:45px}.m-v-45[_ngcontent-%COMP%]{margin:45px 0}.m-h-45[_ngcontent-%COMP%]{margin:0 45px}.m-50[_ngcontent-%COMP%]{margin:50px}.m-t-50[_ngcontent-%COMP%]{margin-top:50px}.m-r-50[_ngcontent-%COMP%]{margin-right:50px}.m-b-50[_ngcontent-%COMP%]{margin-bottom:50px}.m-l-50[_ngcontent-%COMP%]{margin-left:50px}.m-v-50[_ngcontent-%COMP%]{margin:50px 0}.m-h-50[_ngcontent-%COMP%]{margin:0 50px}.m-55[_ngcontent-%COMP%]{margin:55px}.m-t-55[_ngcontent-%COMP%]{margin-top:55px}.m-r-55[_ngcontent-%COMP%]{margin-right:55px}.m-b-55[_ngcontent-%COMP%]{margin-bottom:55px}.m-l-55[_ngcontent-%COMP%]{margin-left:55px}.m-v-55[_ngcontent-%COMP%]{margin:55px 0}.m-h-55[_ngcontent-%COMP%]{margin:0 55px}.m-60[_ngcontent-%COMP%]{margin:60px}.m-t-60[_ngcontent-%COMP%]{margin-top:60px}.m-r-60[_ngcontent-%COMP%]{margin-right:60px}.m-b-60[_ngcontent-%COMP%]{margin-bottom:60px}.m-l-60[_ngcontent-%COMP%]{margin-left:60px}.m-v-60[_ngcontent-%COMP%]{margin:60px 0}.m-h-60[_ngcontent-%COMP%]{margin:0 60px}.m-65[_ngcontent-%COMP%]{margin:65px}.m-t-65[_ngcontent-%COMP%]{margin-top:65px}.m-r-65[_ngcontent-%COMP%]{margin-right:65px}.m-b-65[_ngcontent-%COMP%]{margin-bottom:65px}.m-l-65[_ngcontent-%COMP%]{margin-left:65px}.m-v-65[_ngcontent-%COMP%]{margin:65px 0}.m-h-65[_ngcontent-%COMP%]{margin:0 65px}.m-70[_ngcontent-%COMP%]{margin:70px}.m-t-70[_ngcontent-%COMP%]{margin-top:70px}.m-r-70[_ngcontent-%COMP%]{margin-right:70px}.m-b-70[_ngcontent-%COMP%]{margin-bottom:70px}.m-l-70[_ngcontent-%COMP%]{margin-left:70px}.m-v-70[_ngcontent-%COMP%]{margin:70px 0}.m-h-70[_ngcontent-%COMP%]{margin:0 70px}.m-75[_ngcontent-%COMP%]{margin:75px}.m-t-75[_ngcontent-%COMP%]{margin-top:75px}.m-r-75[_ngcontent-%COMP%]{margin-right:75px}.m-b-75[_ngcontent-%COMP%]{margin-bottom:75px}.m-l-75[_ngcontent-%COMP%]{margin-left:75px}.m-v-75[_ngcontent-%COMP%]{margin:75px 0}.m-h-75[_ngcontent-%COMP%]{margin:0 75px}.m-80[_ngcontent-%COMP%]{margin:80px}.m-t-80[_ngcontent-%COMP%]{margin-top:80px}.m-r-80[_ngcontent-%COMP%]{margin-right:80px}.m-b-80[_ngcontent-%COMP%]{margin-bottom:80px}.m-l-80[_ngcontent-%COMP%]{margin-left:80px}.m-v-80[_ngcontent-%COMP%]{margin:80px 0}.m-h-80[_ngcontent-%COMP%]{margin:0 80px}.no-m[_ngcontent-%COMP%]{margin:0}.no-m-t[_ngcontent-%COMP%]{margin-top:0}.no-m-r[_ngcontent-%COMP%]{margin-right:0}.no-m-b[_ngcontent-%COMP%]{margin-bottom:0}.no-m-l[_ngcontent-%COMP%]{margin-left:0}.no-m-v[_ngcontent-%COMP%], .no-m-h[_ngcontent-%COMP%], .no-margin[_ngcontent-%COMP%]{margin:0}.no-m-lr[_ngcontent-%COMP%], .no-m-rl[_ngcontent-%COMP%]{margin-left:0;margin-right:0}.no-m-tb[_ngcontent-%COMP%], .no-m-bt[_ngcontent-%COMP%]{margin-top:0;margin-bottom:0}.m-t-only[_ngcontent-%COMP%]{margin-left:0;margin-right:0;margin-bottom:0}.m-b-only[_ngcontent-%COMP%]{margin-left:0;margin-right:0;margin-top:0}.m-l-only[_ngcontent-%COMP%]{margin-right:0;margin-top:0;margin-bottom:0}.m-r-only[_ngcontent-%COMP%]{margin-left:0;margin-top:0;margin-bottom:0}.m-auto[_ngcontent-%COMP%]{margin-left:auto;margin-right:auto}.ls-0[_ngcontent-%COMP%]{margin-left:10px;margin-right:10px}html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{-webkit-tap-highlight-color:transparent}div[_ngcontent-%COMP%]{box-sizing:border-box}.color-inherit[_ngcontent-%COMP%]{color:inherit}.no-shadow[_ngcontent-%COMP%]{box-shadow:none}.pointer[_ngcontent-%COMP%]{cursor:pointer}.nolist[_ngcontent-%COMP%]{list-style:none}.actions-menu[_ngcontent-%COMP%]{color:#fff}.alert[_ngcontent-%COMP%]{background-color:#e8f4fd;padding:6px 16px;font-size:.875rem;font-family:Roboto,Helvetica Neue,sans-serif;font-weight:400;line-height:1.43;border-radius:4px;letter-spacing:normal;margin:10px}.alert[_ngcontent-%COMP%]   .message[_ngcontent-%COMP%]{padding:8px 0;font-size:18px}.alert[_ngcontent-%COMP%]   .alert-check[_ngcontent-%COMP%]{color:#359ff4;margin-right:2px;font-size:1.4rem}  .mat-tooltip{font-size:15px;color:#fff!important;background-color:#4461e2b3;border:1px solid rgb(25.7777777778,51.5555555556,166.2222222222);max-width:400px!important;white-space:pre-line!important}.loading[_ngcontent-%COMP%]{position:absolute;min-width:100%;width:100px;height:12px;background:linear-gradient(125deg,#fff,#4461e2,#fff);animation:grow 4s linear infinite,move 4s linear infinite}mat-card-title[_ngcontent-%COMP%]{font-weight:600;font-size:x-large;padding-left:20px;padding-top:20px}html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{overflow:hidden}.overflow-x-scroll[_ngcontent-%COMP%]{max-width:100%;overflow-x:auto}.overflow-no[_ngcontent-%COMP%]{overflow:hidden}.overflow-auto[_ngcontent-%COMP%]{overflow:auto}.overflow-scroll[_ngcontent-%COMP%]{overflow:scroll}.table-container[_ngcontent-%COMP%]{overflow-x:auto;max-width:100%}body[_ngcontent-%COMP%], .no-p[_ngcontent-%COMP%]{padding:0}.no-p-t[_ngcontent-%COMP%]{padding-top:0}.no-p-r[_ngcontent-%COMP%]{padding-right:0}.no-p-b[_ngcontent-%COMP%]{padding-bottom:0}.no-p-l[_ngcontent-%COMP%]{padding-left:0}.no-p-v[_ngcontent-%COMP%], .no-p-h[_ngcontent-%COMP%]{padding:0}.p-5[_ngcontent-%COMP%]{padding:5px}.p-t-5[_ngcontent-%COMP%]{padding-top:5px}.p-r-5[_ngcontent-%COMP%]{padding-right:5px}.p-b-5[_ngcontent-%COMP%]{padding-bottom:5px}.p-l-5[_ngcontent-%COMP%]{padding-left:5px}.p-v-5[_ngcontent-%COMP%]{padding:5px 0}.p-h-5[_ngcontent-%COMP%]{padding:0 5px}.p-10[_ngcontent-%COMP%]{padding:10px}.p-t-10[_ngcontent-%COMP%]{padding-top:10px}.p-b-10[_ngcontent-%COMP%]{padding-bottom:10px}.p-v-10[_ngcontent-%COMP%]{padding:10px 0}.p-h-10[_ngcontent-%COMP%]{padding:0 10px}.p-15[_ngcontent-%COMP%]{padding:15px}.p-t-15[_ngcontent-%COMP%]{padding-top:15px}.p-r-15[_ngcontent-%COMP%]{padding-right:15px}.p-b-15[_ngcontent-%COMP%]{padding-bottom:15px}.p-l-15[_ngcontent-%COMP%]{padding-left:15px}.p-v-15[_ngcontent-%COMP%]{padding:15px 0}.p-h-15[_ngcontent-%COMP%]{padding:0 15px}.p-20[_ngcontent-%COMP%]{padding:20px}.p-t-20[_ngcontent-%COMP%]{padding-top:20px}.p-r-20[_ngcontent-%COMP%]{padding-right:20px}.p-b-20[_ngcontent-%COMP%]{padding-bottom:20px}.p-l-20[_ngcontent-%COMP%]{padding-left:20px}.p-v-20[_ngcontent-%COMP%]{padding:20px 0}.p-h-20[_ngcontent-%COMP%]{padding:0 20px}.p-25[_ngcontent-%COMP%]{padding:25px}.p-t-25[_ngcontent-%COMP%]{padding-top:25px}.p-r-25[_ngcontent-%COMP%]{padding-right:25px}.p-b-25[_ngcontent-%COMP%]{padding-bottom:25px}.p-l-25[_ngcontent-%COMP%]{padding-left:25px}.p-v-25[_ngcontent-%COMP%]{padding:25px 0}.p-h-25[_ngcontent-%COMP%]{padding:0 25px}.p-30[_ngcontent-%COMP%]{padding:30px}.p-t-30[_ngcontent-%COMP%]{padding-top:30px}.p-r-30[_ngcontent-%COMP%]{padding-right:30px}.p-b-30[_ngcontent-%COMP%]{padding-bottom:30px}.p-l-30[_ngcontent-%COMP%]{padding-left:30px}.p-v-30[_ngcontent-%COMP%]{padding:30px 0}.p-h-30[_ngcontent-%COMP%]{padding:0 30px}.p-35[_ngcontent-%COMP%]{padding:35px}.p-t-35[_ngcontent-%COMP%]{padding-top:35px}.p-r-35[_ngcontent-%COMP%]{padding-right:35px}.p-b-35[_ngcontent-%COMP%]{padding-bottom:35px}.p-l-35[_ngcontent-%COMP%]{padding-left:35px}.p-v-35[_ngcontent-%COMP%]{padding:35px 0}.p-h-35[_ngcontent-%COMP%]{padding:0 35px}.p-40[_ngcontent-%COMP%]{padding:40px}.p-t-40[_ngcontent-%COMP%]{padding-top:40px}.p-r-40[_ngcontent-%COMP%]{padding-right:40px}.p-b-40[_ngcontent-%COMP%]{padding-bottom:40px}.p-l-40[_ngcontent-%COMP%]{padding-left:40px}.p-v-40[_ngcontent-%COMP%]{padding-top:40px;padding-bottom:40px}.p-h-40[_ngcontent-%COMP%]{padding:0 40px}.p-45[_ngcontent-%COMP%]{padding:45px}.p-t-45[_ngcontent-%COMP%]{padding-top:45px}.p-r-45[_ngcontent-%COMP%]{padding-right:45px}.p-b-45[_ngcontent-%COMP%]{padding-bottom:45px}.p-l-45[_ngcontent-%COMP%]{padding-left:45px}.p-v-45[_ngcontent-%COMP%]{padding:45px 0}.p-h-45[_ngcontent-%COMP%]{padding:0 45px}.p-50[_ngcontent-%COMP%]{padding:50px}.p-t-50[_ngcontent-%COMP%]{padding-top:50px}.p-r-50[_ngcontent-%COMP%]{padding-right:50px}.p-b-50[_ngcontent-%COMP%]{padding-bottom:50px}.p-l-50[_ngcontent-%COMP%]{padding-left:50px}.p-v-50[_ngcontent-%COMP%]{padding:50px 0}.p-h-50[_ngcontent-%COMP%]{padding:0 50px}.p-55[_ngcontent-%COMP%]{padding:55px}.p-t-55[_ngcontent-%COMP%]{padding-top:55px}.p-r-55[_ngcontent-%COMP%]{padding-right:55px}.p-b-55[_ngcontent-%COMP%]{padding-bottom:55px}.p-l-55[_ngcontent-%COMP%]{padding-left:55px}.p-v-55[_ngcontent-%COMP%]{padding:55px 0}.p-h-55[_ngcontent-%COMP%]{padding:0 55px}.p-60[_ngcontent-%COMP%]{padding:60px}.p-t-60[_ngcontent-%COMP%]{padding-top:60px}.p-r-60[_ngcontent-%COMP%]{padding-right:60px}.p-b-60[_ngcontent-%COMP%]{padding-bottom:60px}.p-l-60[_ngcontent-%COMP%]{padding-left:60px}.p-v-60[_ngcontent-%COMP%]{padding:60px 0}.p-h-60[_ngcontent-%COMP%]{padding:0 60px}.p-65[_ngcontent-%COMP%]{padding:65px}.p-t-65[_ngcontent-%COMP%]{padding-top:65px}.p-r-65[_ngcontent-%COMP%]{padding-right:65px}.p-b-65[_ngcontent-%COMP%]{padding-bottom:65px}.p-l-65[_ngcontent-%COMP%]{padding-left:65px}.p-v-65[_ngcontent-%COMP%]{padding:65px 0}.p-h-65[_ngcontent-%COMP%]{padding:0 65px}.p-70[_ngcontent-%COMP%]{padding:70px}.p-t-70[_ngcontent-%COMP%]{padding-top:70px}.p-r-70[_ngcontent-%COMP%]{padding-right:70px}.p-b-70[_ngcontent-%COMP%]{padding-bottom:70px}.p-l-70[_ngcontent-%COMP%]{padding-left:70px}.p-v-70[_ngcontent-%COMP%]{padding:70px 0}.p-h-70[_ngcontent-%COMP%]{padding:0 70px}.p-75[_ngcontent-%COMP%]{padding:75px}.p-t-75[_ngcontent-%COMP%]{padding-top:75px}.p-r-75[_ngcontent-%COMP%]{padding-right:75px}.p-b-75[_ngcontent-%COMP%]{padding-bottom:75px}.p-l-75[_ngcontent-%COMP%]{padding-left:75px}.p-v-75[_ngcontent-%COMP%]{padding:75px 0}.p-h-75[_ngcontent-%COMP%]{padding:0 75px}.p-80[_ngcontent-%COMP%]{padding:80px}.p-t-80[_ngcontent-%COMP%]{padding-top:80px}.p-r-80[_ngcontent-%COMP%]{padding-right:80px}.p-b-80[_ngcontent-%COMP%]{padding-bottom:80px}.p-l-80[_ngcontent-%COMP%]{padding-left:80px}.p-v-80[_ngcontent-%COMP%]{padding:80px 0}.p-h-80[_ngcontent-%COMP%]{padding:0 80px}.no-padding[_ngcontent-%COMP%]{padding:0!important}.no-pad-lr[_ngcontent-%COMP%], .no-pad-rl[_ngcontent-%COMP%]{padding-left:0;padding-right:0}.no-pad-tb[_ngcontent-%COMP%], .no-pad-bt[_ngcontent-%COMP%]{padding-top:0;padding-bottom:0}.pad-t-only[_ngcontent-%COMP%]{padding-left:0;padding-right:0;padding-bottom:0}.pad-b-only[_ngcontent-%COMP%]{padding-left:0;padding-right:0;padding-top:0}.pad-l-only[_ngcontent-%COMP%]{padding-right:0;padding-top:0;padding-bottom:0}.pad-r-only[_ngcontent-%COMP%]{padding-left:0;padding-top:0;padding-bottom:0}html[_ngcontent-%COMP%], body[_ngcontent-%COMP%], .rel[_ngcontent-%COMP%], .relative[_ngcontent-%COMP%]{position:relative}.abs[_ngcontent-%COMP%], .absolute[_ngcontent-%COMP%]{position:absolute}.fixed[_ngcontent-%COMP%]{position:fixed}.status-active[_ngcontent-%COMP%]{color:#5cb85c}.status-inactive[_ngcontent-%COMP%]{color:#666f73}.status-deleted[_ngcontent-%COMP%]{color:#000}.status-pending[_ngcontent-%COMP%]{color:orange}.status-approved[_ngcontent-%COMP%]{color:#4461e2}.status-overpaid[_ngcontent-%COMP%]{color:purple}.status-chargeoff[_ngcontent-%COMP%]{color:#f39c12}.status-active-overdue[_ngcontent-%COMP%], .status-block[_ngcontent-%COMP%]{color:red}.status-matured[_ngcontent-%COMP%]{color:#ff4000}.subStatus-contract-termination[_ngcontent-%COMP%]{color:#b3b3b3}.mat-step-header[_ngcontent-%COMP%]   .mat-step-icon-state-done[_ngcontent-%COMP%]{background-color:#2af72a}.mat-step-header[_ngcontent-%COMP%]   .mat-step-icon-state-done[_ngcontent-%COMP%]   .status-transfer-progress[_ngcontent-%COMP%]{color:#ff4000}.mat-step-header[_ngcontent-%COMP%]   .mat-step-icon-state-done[_ngcontent-%COMP%]   .status-transfer-hold[_ngcontent-%COMP%]{color:#df0101}html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{-webkit-font-smoothing:antialiased}html[_ngcontent-%COMP%]{font-size:16px}body[_ngcontent-%COMP%]{font-family:Roboto,Helvetica Neue,sans-serif;font-weight:400;font-size:14px;color:#000000de;line-height:1.5;letter-spacing:normal}.mat-h1[_ngcontent-%COMP%], .mat-headline[_ngcontent-%COMP%], .mat-typography[_ngcontent-%COMP%]   .mat-h1[_ngcontent-%COMP%], .mat-typography[_ngcontent-%COMP%]   .mat-headline[_ngcontent-%COMP%], .mat-typography[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%]{font:400 24px/32px Roboto,Helvetica Neue,sans-serif;letter-spacing:normal;margin:0 0 16px}.lh-1[_ngcontent-%COMP%]{line-height:1}.lh-13[_ngcontent-%COMP%]{line-height:1.3}.lh-15[_ngcontent-%COMP%]{line-height:1.5}.bold[_ngcontent-%COMP%], .strong[_ngcontent-%COMP%]{font-weight:700}.no-bold[_ngcontent-%COMP%]{font-weight:400}.italic[_ngcontent-%COMP%], .em[_ngcontent-%COMP%]{font-style:italic}.strike[_ngcontent-%COMP%]{text-decoration:line-through}.normal[_ngcontent-%COMP%]{font-weight:400;font-style:normal}.uppercase[_ngcontent-%COMP%]{text-transform:uppercase}.text-left[_ngcontent-%COMP%]{text-align:left}.text-center[_ngcontent-%COMP%]{text-align:center}.text-right[_ngcontent-%COMP%]{text-align:right}.w100[_ngcontent-%COMP%]{font-weight:100}.w200[_ngcontent-%COMP%]{font-weight:200}.w300[_ngcontent-%COMP%]{font-weight:300}.w400[_ngcontent-%COMP%]{font-weight:400}.w500[_ngcontent-%COMP%]{font-weight:500}.w600[_ngcontent-%COMP%]{font-weight:600}.w700[_ngcontent-%COMP%]{font-weight:700}.w800[_ngcontent-%COMP%]{font-weight:800}.w900[_ngcontent-%COMP%]{font-weight:900}.f9[_ngcontent-%COMP%]{font-size:9px}.f10[_ngcontent-%COMP%]{font-size:10px}.f11[_ngcontent-%COMP%]{font-size:11px}.f12[_ngcontent-%COMP%]{font-size:12px}.f13[_ngcontent-%COMP%]{font-size:13px}.f14[_ngcontent-%COMP%]{font-size:14px}.f15[_ngcontent-%COMP%]{font-size:15px}.f16[_ngcontent-%COMP%]{font-size:16px}.f17[_ngcontent-%COMP%]{font-size:17px}.f18[_ngcontent-%COMP%]{font-size:18px;line-height:30px}.f19[_ngcontent-%COMP%]{font-size:19px}.f20[_ngcontent-%COMP%]{font-size:20px}.f30[_ngcontent-%COMP%]{font-size:30px}.f40[_ngcontent-%COMP%]{font-size:40px}.f50[_ngcontent-%COMP%]{font-size:50px}.f60[_ngcontent-%COMP%]{font-size:60px}.size-small[_ngcontent-%COMP%]{font-size:75%}.size-normal[_ngcontent-%COMP%]{font-size:100%}.size-medium[_ngcontent-%COMP%]{font-size:125%}.size-big[_ngcontent-%COMP%], .size-large[_ngcontent-%COMP%]{font-size:150%}.size-huge[_ngcontent-%COMP%]{font-size:200%}.inherit[_ngcontent-%COMP%]{font:inherit}.text-shadow[_ngcontent-%COMP%]{text-shadow:1px 1px 1px rgba(0,0,0,.4)}.text-rgb-2[_ngcontent-%COMP%]{color:#0003}.text-rgb-3[_ngcontent-%COMP%]{color:#0000004d}.text-rgb-4[_ngcontent-%COMP%]{color:#0006}.text-rgb-5[_ngcontent-%COMP%]{color:#00000080}.no-ul[_ngcontent-%COMP%], .no-ul[_ngcontent-%COMP%]:hover, .no-ul[_ngcontent-%COMP%]   a[_ngcontent-%COMP%], .no-ul[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{text-decoration:none}.no-wrap[_ngcontent-%COMP%]{white-space:nowrap}.auto-cell-size[_ngcontent-%COMP%]{white-space:nowrap;width:1%}.ls-0[_ngcontent-%COMP%]{letter-spacing:-3px;white-space:nowrap}.label-field[_ngcontent-%COMP%]{margin-top:32px}.fit[_ngcontent-%COMP%]{max-width:100%}.half-width[_ngcontent-%COMP%]{width:50%}.full-width[_ngcontent-%COMP%]{width:100%}.full-height[_ngcontent-%COMP%]{height:100%}html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{width:100%;height:100%;min-height:100%}body[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]{width:100%}.container[_ngcontent-%COMP%]{max-width:74rem;width:90%}.mw300[_ngcontent-%COMP%]{max-width:300px}.mw400[_ngcontent-%COMP%]{max-width:400px}.mw500[_ngcontent-%COMP%]{max-width:500px}.mw600[_ngcontent-%COMP%]{max-width:600px}.fullwidth[_ngcontent-%COMP%]{width:100%}.zindex-1[_ngcontent-%COMP%]{z-index:1}.zindex-2[_ngcontent-%COMP%]{z-index:2}.zindex-3[_ngcontent-%COMP%]{z-index:3}.zindex-4[_ngcontent-%COMP%]{z-index:4}.container[_ngcontent-%COMP%]{max-width:37rem}.container[_ngcontent-%COMP%]   .card-content[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]{margin:1rem 0;word-wrap:break-word}.container[_ngcontent-%COMP%]   .card-content[_ngcontent-%COMP%]   mifosx-transaction-payment-detail[_ngcontent-%COMP%]{width:100%;margin-bottom:20px}.transaction-buttons[_ngcontent-%COMP%]{margin-top:3%}.active[_ngcontent-%COMP%]{background-color:#5cb85c;height:4px}.linked[_ngcontent-%COMP%]{background-color:#4461e2;height:4px}.undo[_ngcontent-%COMP%]{background-color:red;height:4px}"]})}}return e})();function Il(e,p){e&1&&(i(0,"div",4),t(1,`
  `),f(2,"div",5),t(3,`
`),a())}function Dl(e,p){if(e&1&&(i(0,"td"),t(1,`
              `),f(2,"mifosx-external-identifier",13),t(3,`
            `),a()),e&2){let n=C(3);o(2),gt("externalId",n.savingsAccountData.externalId)}}function Ol(e,p){e&1&&(i(0,"td"),t(1),c(2,"translate"),a()),e&2&&(o(),u(m(2,1,"labels.inputs.Not Provided")))}function El(e,p){if(e&1&&(i(0,"span"),t(1),c(2,"formatNumber"),a()),e&2){let n=C(3);o(),v("",m(2,1,n.savingsAccountData.nominalAnnualInterestRate)," %")}}function wl(e,p){e&1&&(i(0,"span"),t(1,"0 %"),a())}function Fl(e,p){if(e&1&&(i(0,"div"),t(1,`
      ...
      `),i(6,"table"),t(7,`
        `),i(8,"tbody"),t(9,`
          ...
          `),i(52,"tr"),t(53,`
            ...
            `),i(58,"td",12),t(59,`
              `),d(60,El,3,3,"span",9),t(61,`
              `),d(62,wl,2,0,"span",9),t(63,`
            `),a(),t(64,`
          `),a(),t(65,`
        `),a(),t(66,`
      `),a(),t(67,`
    ...
    `)),e&2){let n=C(2);o(4),u(m(5,5,"labels.heading.Savings Details")),o(10),u(m(15,7,"labels.inputs.Field Officer")),o(4),u(n.savingsAccountData.fieldOfficerName?n.savingsAccountData.fieldOfficerName:"Unassigned"),o(6),u(m(25,9,"labels.inputs.Balance")),o(4),v(`
          ...
          `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Total Interest Earned")),o(4),v(`
            ...
            `)}}function Rl(e,p){if(e&1&&(i(0,"div"),t(1,`
      `),i(2,"h4",11),t(3),c(4,"translate"),a(),t(5,`
      `),i(6,"table"),t(7,`
        `),i(8,"tbody"),t(9,`
          `),d(10,Bl,10,9,"tr",9),t(11,`
          `),d(12,Nl,10,9,"tr",9),t(13,`
        `),a(),t(14,`
      `),a(),t(15,`
    `),a()),e&2){let n=C(2);o(3),u(m(4,3,"labels.heading.Performance History")),o(7),l("ngIf",n.savingsAccountData.summary.totalDeposits),o(2),l("ngIf",n.savingsAccountData.summary.totalInterestEarned>=0)}}function Vl(e,p){if(e&1&&(i(0,"tr"),t(1,`
        ...
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Total Withdrawls")),o(4),v(`
          ...
          `)}}function Ll(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td",12),t(7),c(8,"currency"),a(),t(9,`
        ...
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Nominal Interest Rate")),o(4),v("",m(8,4,n.savingsAccountData.nominalAnnualInterestRate)," %")}}function Wl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td",12),t(7),c(8,"currency"),a(),t(9,`
        ...
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Last Active Transaction Date")),o(4),u(m(8,4,n.savingsAccountData.lastActiveTransactionDate))}}function Kl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),a(),t(8,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Substatus")),o(4),u(n.savingsAccountData.subStatus.value)}}function Yl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),a(),t(8,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Days to Inactive")),o(4),u(n.savingsAccountData.daysToInactive)}}function Jl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),a(),t(8,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Days to Dormancy")),o(4),u(n.savingsAccountData.daysToDormancy)}}function Xl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),a(),t(8,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Days to Escheat")),o(4),u(n.savingsAccountData.daysToEscheat)}}function Zl(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td",12),t(7),c(8,"currency"),a(),t(9,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Annual Fee")),o(4),v(`
          ...
          `)}}function t0(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td",12),t(7),c(8,"currency"),a(),t(9,`
        ...
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Min Balance Required for Interest Calculation")),o(4),u(m(8,4,n.savingsAccountData.minBalanceForInterestCalculation))}}function i0(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),c(8,"formatNumber"),a(),t(9,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Minimum Required Balance")),o(4),u(m(8,4,n.savingsAccountData.minRequiredBalance))}}function a0(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),c(8,"yesNo"),a(),t(9,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Enforce Minimum Required Balance")),o(4),u(m(8,4,n.savingsAccountData.enforceMinRequiredBalance))}}function o0(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),c(8,"dateFormat"),a(),t(9,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Interest Recalculation Date")),o(4),u(m(8,4,n.savingsAccountData.summary.lastInterestCalculationDate))}}function r0(e,p){if(e&1&&(i(0,"a"),t(1),c(2,"currency"),a()),e&2){let n=C(4);o(),u(et(2,1,n.savingsAccountData.onHoldFunds,n.currency.code,"symbol-narrow","1.2-2"))}}function s0(e,p){e&1&&(i(0,"tr"),t(1,`
          ...
          `),i(6,"td"),t(7,`
            `),d(8,r0,3,6,"a",15),t(9,`
          `),a(),t(10,`
        `),a()),e&2&&(o(3),u(m(4,2,"labels.inputs.On Hold Funds")),o(5),l("mifosxHasPermission","READ_SAVINGSACCOUNT"))}function c0(e,p){if(e&1&&(i(0,"tr"),t(1,`
          `),i(2,"td"),t(3),c(4,"translate"),a(),t(5,`
          `),i(6,"td"),t(7),a(),t(8,`
        `),a()),e&2){let n=C(3);o(3),u(m(4,2,"labels.inputs.Withhold Tax Group")),o(4),u(n.savingsAccountData.taxGroup.name)}}function m0(e,p){if(e&1&&(i(0,"div",14),t(1,`
    `),i(2,"h4",11),t(3),c(4,"translate"),a(),t(5,`
    `),i(6,"table"),t(7,`
      `),i(8,"tbody"),t(9,`
        `),d(10,Vl,10,9,"tr",9),t(11,`
        `),d(12,Ll,10,9,"tr",9),t(13,`
        `),d(14,jl,10,9,"tr",9),t(15,`
        `),d(16,Gl,10,9,"tr",9),t(17,`
        `),d(18,Ul,10,9,"tr",9),t(19,`
        `),d(20,ql,10,9,"tr",9),t(21,`
        `),d(22,Hl,10,9,"tr",9),t(23,`
        `),d(24,zl,10,9,"tr",9),t(25,`
        `),d(26,$l,10,6,"tr",9),t(27,`
        `),i(28,"tr"),t(29,`
    ...
    `),i(1,"div",14),t(2,`
      ...
      `),i(7,"table"),t(8,`
        `),i(9,"tbody"),t(10,`
          `),i(11,"tr"),t(12,`
            `),i(13,"td"),t(14),c(15,"translate"),a(),t(16,`
            `),d(17,l0,4,1,"td",9),t(18,`
            `),d(19,p0,3,3,"td",9),t(20,`
          `),a(),t(21,`
          `),i(22,"tr"),t(23,`
  ...
  `)),e&2){let n=C(2);o(4),u(m(5,9,"labels.heading.Account Summary")),o(10),u(m(15,11,"labels.inputs.External Id")),o(3),l("ngIf",n.savingsAccountData.externalId),o(2),l("ngIf",!n.savingsAccountData.externalId),o(6),u(m(26,13,"labels.inputs.Activated On")),o(4),v(`
            ...
            `),o(7),u(m(37,17,"labels.inputs.Currency")),o(4),R("",n.savingsAccountData.currency.name," [",n.savingsAccountData.currency.code,"]")}}function u0(e,p){if(e&1&&(i(0,"div",6),t(1,`
  `),i(2,"div",7),t(3,`
    `),d(4,Fl,68,28,"div",8),t(5,`

    `),d(6,kl,35,16,"ng-template",null,0,ni),t(8,`

    `),d(9,Rl,16,5,"div",9),t(10,`
  `),a(),t(11,`

  `),d(12,m0,104,55,"div",10),t(13,`

  `),d(14,d0,46,19,"ng-template",null,1,ni),t(16,`

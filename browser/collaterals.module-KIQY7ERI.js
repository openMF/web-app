import{$b as V,$e as _t,Ac as N,Cb as X,F as E,Fb as Y,G as y,Hd as ft,I as w,Ic as tt,Ja as t,Jd as xt,Ka as c,La as h,Ma as b,Mc as et,Md as ht,N as Q,Nc as it,O as z,Oc as at,Pc as nt,Qd as bt,Qf as Rt,Ta as B,Tf as Pt,Uc as lt,Wa as m,Xa as p,Xb as F,Xc as ot,Ze as vt,_b as O,_c as rt,_e as gt,ag as Tt,bc as U,bd as mt,bf as St,ca as o,cf as Dt,ec as L,ef as It,fd as pt,ff as Mt,ga as f,gb as W,ha as R,hd as A,hf as Et,ia as P,id as j,if as yt,kf as wt,la as d,ld as H,na as C,nd as st,ra as i,rc as Z,rd as ct,sa as a,sd as dt,ta as u,ua as D,ub as g,va as I,vg as Bt,wd as ut,xa as J,ya as T,yd as Ct,za as K}from"./chunk-FNQXSFZY.js";import"./chunk-O7S4L63H.js";var _=(()=>{class e{constructor(n){this.http=n}getFilteredClients(n,l,r,x,v){let S=new X().set("displayName",x).set("orphansOnly",r.toString()).set("sortOrder",l).set("orderBy",n);return v&&(S=S.set("officeId",v)),this.http.get("/clients",{params:S})}getClientCollateral(n,l){return this.http.get(`/clients/${n}/collaterals/${l}`)}updateClientCollateral(n,l,r){return this.http.put(`/clients/${n}/collaterals/${l}`,r)}deleteCollateral(n,l){return this.http.delete(`/clients/${n}/collaterals/${l}`)}static{this.\u0275fac=function(l){return new(l||e)(w(Y))}}static{this.\u0275prov=E({token:e,factory:e.\u0275fac,providedIn:"root"})}}return e})();var Ht=()=>["edit"];function qt(e,s){e&1&&(i(0,"button",16),t(1,`

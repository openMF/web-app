import{a as D}from"./chunk-ZSPGZWSL.js";import{$a as Z,$c as $,Aa as Ft,Ad as ft,Af as Re,Ba as Mt,Bc as Q,C as H,Ca as E,Cc as _,Cf as Ve,D as Pt,Da as t,Dc as W,Dd as Ne,Df as Le,Ea as p,Ec as tt,Ef as He,F as R,Fa as v,Ga as I,Ha as Te,Hc as kt,Hd as xt,I as h,Ic as Fe,J as C,Ja as he,Jc as et,Ka as Ce,Kc as Ct,Ke as jt,La as ye,Lc as Me,Le as $t,Mc as nt,Me as Ut,Mf as je,Na as N,Nd as Oe,Oa as vt,Ob as q,Oe as Gt,Pc as it,Pe as zt,Qa as o,Ra as s,Rb as Tt,Re as Qt,Sa as Lt,Sb as G,Sc as at,Se as Wt,Tc as ke,U as pe,Ub as ce,Ue as Yt,Vc as yt,Ve as Jt,Wc as Be,Xb as j,Xc as B,Xe as Kt,Y as a,Yc as P,Za as be,Ze as Bt,_a as Ee,aa as S,ab as O,ba as A,bd as rt,ca as Rt,fa as u,fd as Y,fg as $e,gd as ot,ge as qe,ha as m,hd as we,he as Pe,ic as De,jd as st,kd as J,la as n,ld as Ht,ma as e,mb as M,md as K,na as f,nd as lt,oa as V,pa as L,pd as mt,ra as F,rc as k,rd as pt,sa as T,sd as ct,ta as y,tc as Ae,td as dt,te as bt,vd as ut,wa as Vt,wc as ht,xc as z,xd as U,za as At}from"./chunk-4G2PWYOQ.js";import{a as Ot,b as qt}from"./chunk-O7S4L63H.js";var We=()=>["../","edit"],Ye=()=>["../","list-account-transactions"];function Je(i,c){i&1&&(n(0,"button",1),t(1),o(2,"translate"),e()),i&2&&(m("routerLink",N(4,Ye)),a(),v(`
    `,s(2,2,"labels.buttons.View Transactions History"),`
  `))}function Ke(i,c){i&1&&(n(0,"span"),t(1),o(2,"translate"),e()),i&2&&(a(),v(" ",s(2,1,"labels.inputs.Within Bank")," "))}function Xe(i,c){i&1&&(n(0,"span"),t(1),o(2,"translate"),e()),i&2&&(a(),v(" ",s(2,1,"labels.inputs.Own Account")," "))}var Xt=(()=>{class i{constructor(r){this.route=r,this.allowclientedit=!1,this.route.data.subscribe(d=>{this.standingInstructionsData=d.standingInstructionsData,this.standingInstructionsData.fromClient.id===this.standingInstructionsData.toClient.id&&(this.allowclientedit=!1)})}static{this.\u0275fac=function(d){return new(d||i)(S(q))}}static{this.\u0275cmp=A({type:i,selectors:[["mifosx-view-standing-instructions"]],decls:215,vars:90,consts:[[1,"layout-row","align-end","gap-2px","responsive-column","container","m-b-20"],["mat-raised-button","","color","primary",3,"routerLink"],["icon","edit",1,"m-r-10"],["mat-raised-button","","color","primary",3,"routerLink",4,"mifosxHasPermission"],[1,"container"],[1,"layout-row-wrap","responsive-column"],[1,"mat-h2","flex-fill"],[3,"inset"],[1,"flex-fill"],[1,"flex-40"],[1,"flex-60"],[4,"ngIf"]],template:function(d,l){d&1&&(n(0,"div",0),t(1,`
  `),n(2,"button",1),t(3,`
...
`),n(11,"div",4),t(12,`
  ...
  `),e(),t(213,`
`),e(),t(214,`
`)),d&2&&(a(2),m("routerLink",N(89,We)),a(3),v(`
  ...
  `),a(3),m("mifosxHasPermission","READ_ACCOUNTTRANSFER"),a(12),p(l.standingInstructionsData.name),a(2),m("inset",!0),a(5),v("",s(28,47,"labels.inputs.Applicant"),":"),a(4),p(l.standingInstructionsData.fromClient.displayName),a(6),v("",s(38,49,"labels.inputs.Type"),":"),a(4),p(l.standingInstructionsData.transferType.value),a(6),v("",s(48,51,"labels.inputs.Priority"),":"),a(4),p(l.standingInstructionsData.priority.value),a(6),v("",s(58,53,"labels.inputs.Status"),":"),a(4),p(l.standingInstructionsData.status.value),a(6),v("",s(68,55,"labels.inputs.From Account Type"),":"),a(4),p(l.standingInstructionsData.fromAccountType.value),a(6),v("",s(78,57,"labels.inputs.From Account"),":"),a(4),I("",l.standingInstructionsData.fromAccount.productName,` -
            ...
            `,s(167,77,l.standingInstructionsData.validTill),""),a(8),v("",s(174,79,"labels.inputs.Recurrence Type"),":"),a(4),p(l.standingInstructionsData.recurrenceType.value),a(6),v("",s(184,81,"labels.inputs.Interval"),":"),a(4),p(l.standingInstructionsData.recurrenceInterval),a(6),v("",s(194,83,"labels.inputs.Recurrence Frequency"),":"),a(4),p(l.standingInstructionsData.recurrenceFrequency.value),a(6),v("",s(204,85,"labels.inputs.On Month Day"),":"),a(4),p(s(208,87,l.standingInstructionsData.recurrenceOnMonthDay)))},dependencies:[M,O,B,G,P,$,j,ut,U,k,ft,xt],styles:[".mat-elevation-z1[_ngcontent-%COMP%]{margin:1em 0 1.5em}h2[_ngcontent-%COMP%], h3[_ngcontent-%COMP%], h4[_ngcontent-%COMP%]{margin:0;font-weight:500}span[_ngcontent-%COMP%]{margin:.5em 0}.margin-t[_ngcontent-%COMP%]{margin-top:1em}mat-divider[_ngcontent-%COMP%]{margin:0 0 1em}"]})}}return i})();var Ze=()=>["../view"];function tn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function nn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function rn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
              `)}}function on(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Valid From Date")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function sn(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function pn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
              `)}}function cn(i,c){if(i&1){let r=F();n(0,"button",35),T("click",function(){h(r);let l=y();return C(l.submit())}),t(1),o(2,"translate"),e()}if(i&2){let r=y();m("disabled",!r.editStandingInstructionsForm.valid),a(),v(`
...
`)}if(d&2){let x=E(160),g=E(176),b=E(227);a(4),m("formGroup",l.editStandingInstructionsForm),a(9),p(s(14,46,"labels.inputs.name")),a(9),p(s(23,48,"labels.inputs.Applicant")),a(9),p(s(32,50,"labels.inputs.Type")),a(9),p(s(41,52,"labels.inputs.From Account Type")),a(9),p(s(50,54,"labels.inputs.Priority")),a(5),m("ngForOf",l.priorityTypeData),a(3),m("ngIf",l.editStandingInstructionsForm.controls.priority.hasError("required")),a(6),p(s(64,56,"labels.inputs.Status")),a(5),m("ngForOf",l.statusTypeData),a(3),m("ngIf",l.editStandingInstructionsForm.controls.status.hasError("required")),a(6),p(s(78,58,"labels.inputs.From Account")),a(9),p(s(87,60,"labels.inputs.Destination")),a(9),p(s(96,62,"labels.inputs.To Office")),a(9),p(s(105,64,"labels.inputs.Beneficiary")),a(9),p(s(114,66,"labels.inputs.To Account Type")),a(9),p(s(123,68,"labels.inputs.To Account")),a(9),p(s(132,70,"labels.inputs.Standing Instruction Type")),a(5),m("ngForOf",l.instructionTypeData),a(7),p(s(144,72,"labels.inputs.Amount")),a(9),p(s(153,74,"labels.inputs.Validity from")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",x),a(2),m("for",x),a(5),m("ngIf",l.editStandingInstructionsForm.controls.validFrom.hasError("required")),a(6),p(s(169,76,"labels.inputs.Validity To")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",g),a(2),m("for",g),a(5),m("ngIf",l.editStandingInstructionsForm.controls.validTill.hasError("required")),a(6),p(s(185,78,"labels.inputs.Recurrence Type")),a(5),m("ngForOf",l.recurrenceTypeData),a(3),m("ngIf",l.editStandingInstructionsForm.controls.recurrenceType.hasError("required")),a(6),p(s(199,80,"labels.inputs.Interval")),a(9),p(s(208,82,"labels.inputs.Recurrence Frequency")),a(5),m("ngForOf",l.recurrenceFrequencyTypeData),a(7),p(s(220,84,"labels.inputs.On Month Day")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",b),a(2),m("for",b),a(10),m("routerLink",N(88,Ze)),a(),v(`
        ...
        `),a(3),m("mifosxHasPermission","UPDATE_STANDINGINSTRUCTION")}},dependencies:[M,Z,O,B,et,Q,W,tt,at,nt,it,G,P,$,rt,J,Y,ot,st,K,mt,lt,ct,dt,pt,j,U,k],encapsulation:2})}}return i})();var dn=()=>["../"];function un(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function hn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),I(`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function En(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.name,`
              `)}}function Dn(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
            ...
            `),e()),i&2&&(a(),I(`
              ...
              `),a(4),p(s(6,7,"labels.commons.required")))}function Bn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),I(`
                `,r.productName," - ",r.accountNo,`
              `)}}function wn(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
            ...
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Recurrence Type")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function Hn(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Recurrence Interval")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function jn(i,c){if(i&1&&(n(0,"mat-option",34),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
              `)}}function $n(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Recurrence Frequency")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function Un(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.On Month Day")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function Gn(i,c){if(i&1){let r=F();n(0,"button",35),T("click",function(){h(r);let l=y();return C(l.submit())}),t(1),o(2,"translate"),e()}if(i&2){let r=y();m("disabled",!r.createStandingInstructionsForm.valid),a(),v(`
          `,s(2,2,"labels.buttons.Submit"),`
      ...
      `),n(6,"mat-card-content"),t(7,`
        `),n(8,"div",5),t(9,`
          ...
          `),n(100,"mat-form-field",6),t(101,`
            ...
            `),e(),t(110,`
            `),u(111,bn,8,9,"mat-error",8),t(112,`
          `),e(),t(113,`
          ...
          `),n(128,"mat-form-field",6),t(129,`
            ...
            `),e(),t(138,`
            `),u(139,Fn,8,9,"mat-error",8),t(140,`
          `),e(),t(141,`
          ...
          `),n(142,"mat-form-field",6),t(143,`
            ...
            `),n(148,"mat-select",19),T("selectionChange",function(){return h(x),C(l.changeEvent())}),t(149,`
              `),u(150,Mn,2,2,"mat-option",11),t(151,`
            `),e(),t(152,`
          ...
          `),n(156,"mat-form-field",6),t(157,`
            ...
            `),n(162,"mat-select",20),T("selectionChange",function(){return h(x),C(l.changeEvent())}),t(163,`
              `),u(164,Bn,2,3,"mat-option",11),t(165,`
            `),e(),t(166,`
            `),u(167,wn,8,9,"mat-error",8),t(168,`
          `),e(),t(169,`
          ...
          `),n(170,"mat-form-field",6),t(171,`
            ...
            `),e(),t(180,`
            `),u(181,On,8,9,"mat-error",8),t(182,`
          `),e(),t(183,`
          ...
          `),n(195,"mat-form-field",23),T("click",function(){h(x);let b=E(206);return C(b.open())}),t(196,`
            ...
            `),u(208,Pn,8,9,"mat-error",8),t(209,`
          `),e(),t(210,`
...
`)}if(d&2){let x=E(206),g=E(222),b=E(277);a(4),m("formGroup",l.createStandingInstructionsForm),a(9),p(s(14,70,"labels.inputs.name")),a(5),m("ngIf",l.createStandingInstructionsForm.controls.name.hasError("required")),a(6),p(s(25,72,"labels.inputs.Applicant")),a(9),p(s(34,74,"labels.inputs.Type")),a(5),m("ngForOf",l.transferTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.transferType.hasError("required")),a(6),p(s(48,76,"labels.inputs.Priority")),a(5),m("ngForOf",l.priorityTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.priority.hasError("required")),a(6),p(s(62,78,"labels.inputs.Status")),a(5),m("ngForOf",l.statusTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.status.hasError("required")),a(6),p(s(76,80,"labels.inputs.From Account Type")),a(5),m("ngForOf",l.fromAccountTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.fromAccountType.hasError("required")),a(6),p(s(90,82,"labels.inputs.From Account")),a(5),m("ngForOf",l.fromAccountData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.fromAccountId.hasError("required")),a(6),p(s(104,84,"labels.inputs.Destination")),a(5),m("ngForOf",l.destinationTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.destination.hasError("required")),a(6),p(s(118,86,"labels.inputs.To Office")),a(3),m("disabled",l.ToOfficeId),a(2),m("ngForOf",l.toOfficeTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.toOfficeId.hasError("required")),a(6),p(s(132,88,"labels.inputs.Beneficiary")),a(3),m("disabled",l.ToClientId),a(2),m("ngForOf",l.toClientTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.toClientId.hasError("required")),a(6),p(s(146,90,"labels.inputs.To Account Type")),a(5),m("ngForOf",l.toAccountTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.toAccountType.hasError("required")),a(6),p(s(160,92,"labels.inputs.To Account")),a(5),m("ngForOf",l.toAccountData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.toAccountId.hasError("required")),a(6),p(s(174,94,"labels.inputs.Standing Instruction Type")),a(5),m("ngForOf",l.instructionTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.instructionType.hasError("required")),a(6),p(s(188,96,"labels.inputs.Amount")),a(5),m("ngIf",l.createStandingInstructionsForm.controls.amount.hasError("required")),a(6),p(s(199,98,"labels.inputs.Validity from")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",x),a(2),m("for",x),a(5),m("ngIf",l.createStandingInstructionsForm.controls.validFrom.hasError("required")),a(6),p(s(215,100,"labels.inputs.Validity To")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",g),a(2),m("for",g),a(5),m("ngIf",l.createStandingInstructionsForm.controls.validTill.hasError("required")),a(6),p(s(231,102,"labels.inputs.Recurrence Type")),a(5),m("ngForOf",l.recurrenceTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.recurrenceType.hasError("required")),a(6),p(s(245,104,"labels.inputs.Interval")),a(5),m("ngIf",l.createStandingInstructionsForm.controls.recurrenceInterval.hasError("required")),a(6),p(s(256,106,"labels.inputs.Recurrence Frequency")),a(5),m("ngForOf",l.recurrenceFrequencyTypeData),a(3),m("ngIf",l.createStandingInstructionsForm.controls.recurrenceFrequency.hasError("required")),a(6),p(s(270,108,"labels.inputs.On Month Day")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",b),a(2),m("for",b),a(5),m("ngIf",l.createStandingInstructionsForm.controls.recurrenceOnMonthDay.hasError("required")),a(7),m("routerLink",N(112,dn)),a(),v(`
        ...
        `),a(3),m("mifosxHasPermission","CREATE_STANDINGINSTRUCTION")}},dependencies:[M,Z,O,B,et,Q,Ct,W,tt,at,nt,it,G,P,$,rt,J,Y,ot,st,K,mt,lt,ct,dt,pt,j,U,k],encapsulation:2})}}return i})();var zn=i=>({balance:i});function Qn(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
      `),e()),i&2&&(a(),I(`
...
`)}if(d&2){let x,g=E(15);m("formGroup",l.makeAccountTransferForm),a(7),p(s(8,16,"labels.inputs.Transaction Date")),a(3),m("min",l.minDate)("max",l.maxDate)("matDatepicker",g),a(2),m("for",g),a(5),m("ngIf",l.makeAccountTransferForm.controls.transferDate.hasError("required")),a(6),p(s(24,18,"labels.inputs.Bank")),a(9),p(s(33,20,"labels.inputs.Client")),a(9),p(s(42,22,"labels.inputs.Account Type")),a(9),p(s(51,24,"labels.inputs.Account")),a(9),p(s(60,26,"labels.inputs.Amount")),a(6),m("ngIf",l.makeAccountTransferForm.controls.transferAmount.hasError("required")),a(2),m("ngIf",(x=l.makeAccountTransferForm.get("transferAmount"))==null?null:x.hasError("amountExceedsBalance")),a(6),p(s(74,28,"labels.inputs.Description")),a(5),m("ngIf",l.makeAccountTransferForm.controls.transferDescription.hasError("required"))}},dependencies:[M,O,B,et,Q,Ct,W,tt,at,nt,it,J,Y,ot,st,K,ct,dt,pt,k,ft,Ht],styles:["h2[_ngcontent-%COMP%], h3[_ngcontent-%COMP%], h4[_ngcontent-%COMP%]{margin:0;font-weight:500}span[_ngcontent-%COMP%]{margin:.5em 0}.margin-t[_ngcontent-%COMP%]{margin-top:1em}mat-divider[_ngcontent-%COMP%]{margin:0 0 .5em}.container[_ngcontent-%COMP%]{max-width:37rem}"]})}}return i})();var Ge=()=>["../.."],Kn=i=>({balance:i});function Xn(i,c){i&1&&(n(0,"div",6),t(1,`
  ...
  `),e())}function Zn(i,c){if(i&1){let r=F();n(0,"button",26),T("click",function(){h(r);let l=y(4);return C(l.searchAccountByNumber())}),t(1),o(2,"translate"),e()}if(i&2){let r=y(4);m("disabled",r.phoneAccount.length!==10),a(),v(`
        ...
        `),u(22,ti,8,6,"mat-card-actions",19),t(23,`
      `),e()}if(i&2){let r=y(2);a(5),v(`
            `,s(6,6,"labels.heading.Transferred To"),`
          `),a(6),p(s(12,8,"labels.inputs.Phone Number")),a(3),m("disabled",r.interbankTransferForm),he("ngModel",r.phoneAccount),a(4),v("",r.phoneAccount.length||0,"/10"),a(4),m("ngIf",!r.interbankTransferForm)}}function ni(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Transaction Date")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function ii(i,c){if(i&1&&(n(0,"mat-option",41),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.name,`
              `)}}function ai(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Office")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function ri(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Client")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function oi(i,c){if(i&1&&(n(0,"mat-option",41),t(1),e()),i&2){let r=c.$implicit;m("value",r),a(),I(`
              `,r.id," - ",r.displayName,`
            `)}}function si(i,c){if(i&1&&(n(0,"mat-option",41),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
                `,r.value,`
              `)}}function li(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Account Type")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function mi(i,c){if(i&1&&(n(0,"mat-option",41),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),I(`
                `,r.productName," - ",r.accountNo,`
              `)}}function pi(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Account")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function ci(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Amount")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function di(i,c){if(i&1&&(n(0,"mat-error"),t(1,`
              `),f(2,"fa-icon",42),t(3),o(4,"translate"),e()),i&2){let r=y(3);a(3),v(`
              `,Lt(4,1,"errors.validation.msg.savingsproduct.insufficient.balance",vt(4,Kn,r.balance)),`
            `)}}function ui(i,c){i&1&&(n(0,"mat-error"),t(1),o(2,"translate"),o(3,"translate"),n(4,"strong"),t(5),o(6,"translate"),e(),t(7,`
            `),e()),i&2&&(a(),I(`
              `,s(2,3,"labels.inputs.Transfer Description")," ",s(3,5,"labels.commons.is"),`
              `),a(4),p(s(6,7,"labels.commons.required")))}function fi(i,c){if(i&1){let r=F();n(0,"form",27),t(1,`
        `),n(2,"div",28),t(3,`
          ...
          `),n(51,"mat-form-field",32),t(52,`
            ...
            `),n(57,"mat-select",37),T("selectionChange",function(){h(r);let l=y(2);return C(l.changeEvent())}),t(58,`
              `),u(59,si,2,2,"mat-option",34),t(60,`
            `),e(),t(61,`
            `),u(62,li,8,9,"mat-error",5),t(63,`
          `),e(),t(64,`
    ...
    `),n(2,"mat-card-content"),t(3,`
      ...
      `),u(63,ei,24,10,"div",5),t(64,`

      `),f(65,"mat-divider",13),t(66,`

      `),u(67,fi,104,40,"form",17),t(68,`
      `),u(69,xi,1,2,"mifosx-make-account-interbank-transfers",18),t(70,`
    `),e(),t(71,`

    `),u(72,Ii,8,6,"mat-card-actions",19),t(73,`
...
`)),d&2&&(a(2),m("ngIf",l.isLoading),a(2),m("ngIf",!l.isLoading))},dependencies:[M,Z,O,B,et,Q,Ct,W,tt,at,ke,nt,it,G,P,$,rt,J,Y,ot,st,K,mt,lt,ct,dt,pt,j,U,k,xt,Be,Fe,we,Pe,qe,ft,Ht,ae],styles:["h2[_ngcontent-%COMP%], h3[_ngcontent-%COMP%], h4[_ngcontent-%COMP%]{margin:0;font-weight:500}span[_ngcontent-%COMP%]{margin:.5em 0}.margin-t[_ngcontent-%COMP%]{margin-top:1em}mat-divider[_ngcontent-%COMP%]{margin:0 0 .5em}.container[_ngcontent-%COMP%]{max-width:37rem}  mat-form-field.error-warn.mat-form-field-invalid .mat-form-field-ripple{background-color:#000000de!important}  mat-form-field.error-warn.mat-form-field-invalid .mat-form-field-label{color:#0009!important}  mat-form-field.error-warn.mat-form-field-invalid .mat-form-field-label .mat-form-field-required-marker{color:#0009!important}  mat-form-field.error-warn.mat-form-field-invalid .mat-error{color:#0009!important}"]})}}return i})();var Si=["instructionsTable"],gi=()=>[10,25,50,100],Ti=i=>["../",i,"edit"],hi=i=>["../",i,"view"];function Ci(i,c){if(i&1&&(n(0,"div",23),t(1,`
      ...
      `),e(),t(14,`
    `),e()),i&2){let r=y();a(5),p(s(6,2,"labels.heading.Client Type")),a(7),p(r.clientName)}}function yi(i,c){if(i&1&&(n(0,"div",23),t(1,`
      ...
      `),n(7,"mat-form-field",5),t(8,`
        `),f(9,"input",28),t(10,`
      `),e(),t(11,`
    `),e()),i&2){let r=y();a(4),m("formControl",r.clientNameControl),a(5),m("formControl",r.fromClientId)}}function bi(i,c){if(i&1&&(n(0,"mat-option",29),t(1),e()),i&2){let r=c.$implicit;m("value",r.id),a(),v(`
          `,r.value,`
        `)}}function Ei(i,c){if(i&1){let r=F();n(0,"button",30),T("click",function(){h(r);let l=y();return C(l.filterStandingInstructions())}),t(1),o(2,"translate"),e()}i&2&&(a(),v(`
      \xA0\xA0`,s(2,1,"labels.buttons.Filter"),`
    `))}function Di(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.Client")))}function Ai(i,c){if(i&1&&(n(0,"td",32),t(1),e()),i&2){let r=c.$implicit;a(),I(`
        `,r.fromClient.displayName,"-",r.fromClient.id,`
      `)}}function Fi(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.From Account")))}function Mi(i,c){if(i&1&&(n(0,"td",32),t(1),e()),i&2){let r=c.$implicit;a(),I(`
        `,r.fromAccount.accountNo," (",r.fromAccountType.value,`)
      `)}}function ki(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.Beneficiary")))}function Bi(i,c){if(i&1&&(n(0,"td",32),t(1),e()),i&2){let r=c.$implicit;a(),p(r.toClient.displayName)}}function wi(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.To Account")))}function Ni(i,c){if(i&1&&(n(0,"td",32),t(1),e()),i&2){let r=c.$implicit;a(),I(`
        `,r.toAccount.accountNo," (",r.toAccountType.value,`)
      `)}}function Oi(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.Amount")))}function qi(i,c){if(i&1&&(n(0,"td",32),t(1),e()),i&2){let r=c.$implicit;a(),I("",r.instructionType.value,"/",r.amount,"")}}function Pi(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.Validity")))}function Ri(i,c){if(i&1&&(n(0,"td",32),t(1),o(2,"dateFormat"),o(3,"dateFormat"),e()),i&2){let r=c.$implicit;a(),I(`
        `,s(2,2,r.validFrom)," to ",s(3,4,r.validTill),`
      `)}}function Vi(i,c){i&1&&(n(0,"th",31),t(1),o(2,"translate"),e()),i&2&&(a(),p(s(2,1,"labels.inputs.Actions")))}function Li(i,c){if(i&1&&(n(0,"button",35),o(1,"translate"),t(2,`
            `),f(3,"i",36),t(4,`
          `),e()),i&2){let r=y(2).$implicit;Vt("matTooltip",s(1,2,"tooltips.Edit Standing Instruction")),m("routerLink",vt(4,Ti,r.id))}}function Hi(i,c){i&1&&(n(0,"span"),t(1,`
          `),u(2,Li,5,6,"button",34),t(3,`
        `),e()),i&2&&(a(2),m("mifosxHasPermission","UPDATE_STANDINGINSTRUCTION"))}function ji(i,c){if(i&1){let r=F();n(0,"button",38),o(1,"translate"),T("click",function(){h(r);let l=y(2).$implicit,x=y();return C(x.deleteStandingInstruction(l.id))}),t(2,`
            `),f(3,"i",39),t(4,`
          `),e()}i&2&&Vt("matTooltip",s(1,1,"tooltips.Delete Standing Instruction"))}function $i(i,c){i&1&&(n(0,"span"),t(1,`
          `),u(2,ji,5,3,"button",37),t(3,`
        `),e()),i&2&&(a(2),m("mifosxHasPermission","DELETE_STANDINGINSTRUCTION"))}function Ui(i,c){if(i&1&&(n(0,"button",35),o(1,"translate"),t(2,`
          `),f(3,"i",40),t(4,`
        `),e()),i&2){let r=y().$implicit;Vt("matTooltip",s(1,2,"tooltips.View Standing Instruction")),m("routerLink",vt(4,hi,r.id))}}function Gi(i,c){if(i&1&&(n(0,"td",32),t(1,`
        `),u(2,Hi,4,1,"span",33),t(3,`
        `),u(4,$i,4,1,"span",33),t(5,`
        `),u(6,Ui,5,6,"button",34),t(7,`
  ...
  `),n(2,"div",2),t(3,`
    `),u(4,Ci,15,4,"div",3),t(5,`

    `),u(6,yi,12,2,"div",3),t(7,`
    ...
    `),u(27,Ei,3,3,"button",9),t(28,`
  `),e(),t(29,`

  `),n(30,"table",10,0),t(32,`
    `),V(33,11),t(34,`
      `),u(35,Di,3,3,"th",12),t(36,`
      `),u(37,Ai,2,2,"td",13),t(38,`
    `),L(),t(39,`

    `),V(40,14),t(41,`
      `),u(42,Fi,3,3,"th",12),t(43,`
      `),u(44,Mi,2,2,"td",13),t(45,`
    `),L(),t(46,`

    `),V(47,15),t(48,`
      `),u(49,ki,3,3,"th",12),t(50,`
      `),u(51,Bi,2,1,"td",13),t(52,`
    `),L(),t(53,`

    `),V(54,16),t(55,`
      `),u(56,wi,3,3,"th",12),t(57,`
      `),u(58,Ni,2,2,"td",13),t(59,`
    `),L(),t(60,`

    `),V(61,17),t(62,`
      `),u(63,Oi,3,3,"th",12),t(64,`
      `),u(65,qi,2,2,"td",13),t(66,`
    `),L(),t(67,`

    `),V(68,18),t(69,`
      `),u(70,Pi,3,3,"th",12),t(71,`
      `),u(72,Ri,4,6,"td",13),t(73,`
    `),L(),t(74,`

    `),V(75,19),t(76,`
      `),u(77,Vi,3,3,"th",12),t(78,`
      `),u(79,Gi,8,3,"td",13),t(80,`
    `),L(),t(81,`

    `),u(82,zi,1,0,"tr",20),t(83,`
    `),u(84,Qi,1,0,"tr",21),t(85,`
  `),e(),t(86,`

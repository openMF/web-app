...
export class DepositsService {
  ...
  /**
   * @param {string} params Params object having Client ID and Product ID.
   * @returns {Observable<any>} Recurring Deposit Account Template Data.
   */
  getRecurringDepositAccountsTemplate(params: any): Observable<any> {
    return this.http.get('/recurringdepositaccounts/template', { params: params });
  }
  ...
  /**
   * @param {any} params Params object having Recurring Deposit Account Data
   * @returns {Observable<any>}
   */
  createRecurringDepositAccount(params: any): Observable<any> {
    return this.http.post('/recurringdepositaccounts/', params);
  }
}

...
@Component({
  selector: 'mifosx-create-loan-product-classic',
  templateUrl: './create-loan-product-classic.component.html',
  styleUrls: ['./create-loan-product-classic.component.scss'],
  imports: [
...
export class CreateLoanProductClassicComponent extends LoanProductBaseComponent implements OnInit, AfterViewInit {

...
const generalDataTranslationKeys = [
  ...
  'labels.inputs.Borough / City / Delegation / Municipality / Locality / Town',
  'labels.inputs.Yes / No',
  'labels.inputs.Affiliation',
  'labels.inputs.Reporting period',
  'labels.inputs.Main Activities',
  'labels.inputs.Period reported',
  'labels.inputs.Monthly Income Amount',
  'labels.inputs.Monthly Expenditure Amount',
  'labels.inputs.Where do the funds to open the account come from?',
  'labels.inputs.Allocation of resources for operations',
  'labels.inputs.Number of Shares',
  'labels.inputs.% of Shares',
  'labels.inputs.Use: Single family residential building',
  'labels.inputs.Spouse Full Name',
  'labels.inputs.No. of Shares',
  'labels.inputs.% Shares',
  'labels.inputs.Level of Control',
  'labels.inputs.Position within the Entity',
  'labels.inputs.Institution',
  'labels.inputs.Level and charge',
  'labels.inputs.Key Functions',
  'labels.inputs.No Ext',
  'labels.inputs.No Int',
  'labels.inputs.Neighborhood',
  'labels.inputs.Zip code',
  'labels.heading.Legal Entity',
  'labels.heading.Natural Person',

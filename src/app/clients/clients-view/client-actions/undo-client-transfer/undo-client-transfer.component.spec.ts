...
describe('UndoClientTransferComponent', () => {
  ...
  it('should initialize correctly', () => {
    ...
    expect(component.undoClientTransferForm).toBeDefined();
  });

  it('should call API with withdrawTransfer command on submit', () => {
    component.submit();

    expect(clientsService.executeClientCommand).toHaveBeenCalledWith(clientId, 'withdrawTransfer', expect.any(Object));
  });
  ...
  it('should notify and navigate after successful submission', () => {
    ...
    expect(notifier.notifyAndNavigate).toHaveBeenCalledWith(
      'clients.actions.undoTransfer.success',

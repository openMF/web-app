...
export const environment = {
  ...
  fineractPlatformTenantIds: loadedEnv.fineractPlatformTenantIds || 'default',
    // For local dev & Netlify: use relative proxy path so browser hits same-origin '/api/...'
  baseApiUrls: loadedEnv.fineractApiUrls || '/api',
  baseApiUrl:
    loadedEnv.fineractApiUrl ||
    (loadedEnv.fineractApiUrls?.length > 0 ? loadedEnv.fineractApiUrls.split(',')[0] : '/api'),

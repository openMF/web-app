...
export const ROUTES: AppRoutes = {
  ...
  home: '/#/home',
  clients: '/#/members',
  clientCreate: '/#/members/create',
  clientView: (id) => `/#/members/${id}/general`,
  clientPersonalData: (id) => `/#/members/${id}/personal-data`,
  clientAction: (id, action) => `/#/members/${id}/actions/${encodeURIComponent(action)}`,
  groups: '/#/groups',
